...
def _manual_genre_prompt(
    ...
    return (
        ...
        f'{_art_style_context(settings)}'
        f'\n'
        f'Treat the Genre value as user-provided inspiration, then create a specific caption with a clear, forward melodic {language} {settings.vocal_gender} vocal.\n'
        f'When the Genre value names an artist, producer, band, or person, render it as a descriptive style label using genre family, era, arrangement, and sound character, and leave the name out of the output.\n'
        f'\n'
        f'Generate one single-line music caption with these dimensions:\n'
        f'voice placement, specific sub-style, instrumentation, production texture, tempo feel, and mood.\n'
        f'\n'
...
def _manual_genre_production_prompt(
    ...
    return (
        ...
        f'{_art_style_context(settings)}'
        f'\n'
        f'Treat the Genre value as user-provided inspiration, then create a music caption for a fully produced arrangement with a clear, forward melodic {language} {settings.vocal_gender} vocal.\n'
        f'When the Genre value names an artist, producer, band, or person, render it as a descriptive style label using genre family, era, arrangement, and sound character, and leave the name out of the output.\n'
        f'\n'
        f'Generate one single-line music caption with these dimensions:\n'
        f'specific sub-style, instrumentation, production texture, tempo feel, melodic {language} {settings.vocal_gender} vocal, vocal presence, and mood.\n'
