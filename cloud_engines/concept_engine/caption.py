...
def _auto_genre_prompt(
    ...
    return (
        ...
        f'- Optionally include BPM if the genre implies a specific tempo (e.g., "120 BPM" for techno)\n'
...
def _manual_genre_prompt(
    ...
    return (
        ...
        f'\n'
        f'Generate a single-line music caption in this format:\n'
        f'[vocal type] {language} {settings.vocal_gender} vocal, {settings.genre}, [2-3 specific instruments], [2-3 mood words]\n'
        f'\n'
        f'Rules:\n'
        f'- Voice description MUST come first — this ensures clear pronunciation\n'
        f'- Under 20 words total\n'
...
def _auto_genre_production_prompt(
    ...
    return (
        ...
        f'\n'
        f'Generate a single-line music caption in this format:\n'
        f'[genre at BPM], [2-3 instruments], melodic {language} {settings.vocal_gender} vocal, [2-3 emotional descriptors], clear diction\n'
        f'\n'
        f'Example outputs:\n'
        f'- upbeat indie pop at 120 BPM, bright acoustic guitar, punchy drums, melodic Italian female vocal, playful, sunny, clear diction\n'
        f'- cinematic orchestral waltz at 90 BPM, sweeping strings, gentle harp, soaring German male vocal, bittersweet, nostalgic, clear diction\n'
        f'- groovy funk at 105 BPM, slap bass, wah-wah guitar, smooth Korean female vocal, cheeky, confident, clear diction\n'
        f'\n'
        f'Rules:\n'
        f'- Lead with genre and BPM — this sets the song\'s energy\n'
        f'- BPM range: 80-140 (match the word\'s emotional energy)\n'
...
def _manual_genre_production_prompt(
    ...
    return (
        ...
        f'\n'
        f'Generate a single-line music caption in this format:\n'
        f'{settings.genre} at [BPM], [2-3 instruments typical of {settings.genre}], melodic {language} {settings.vocal_gender} vocal, [2-3 emotional descriptors], clear diction\n'
        f'\n'
        f'Rules:\n'
        f'- Choose a BPM appropriate for {settings.genre} (80-140 range)\n'
