...
def _creative_direction_block(mode: str, blacklist: list[str] | None = None) -> str:
    ...
    blocks = {
        "editorial": (
            ...
            "with curated visual quality — the kind of imagery you would expect to see "
            "in a high-end magazine or photo essay.\n\n"
            ...
            "intentional. The frame feels like someone made specific choices about what "
            "is in it and what is not. Nothing accidental, nothing busy.\n\n"
            "Specifically:\n"
            "- Composition: leave breathing room around the subject; avoid cluttered frames\n"
            "- Lighting: pick a single dominant light source and let it shape the scene\n"
            "- Material: surfaces should look real and considered — fabric, skin, "
            "ceramics, wood, glass — not generic\n"
            "- Mood: restrained and confident, not loud\n\n"
            "The image should feel like it belongs in a curated collection. Clarity "
            "wins over cleverness."
        ),
        "cinematic": (
            "=== CINEMATIC ===\n\n"
            "Your job is to create an image that feels like a single frame pulled from "
            "an emotionally charged film. The viewer should feel the weight of a story, "
            "even though they only see one moment.\n\n"
            "Pick a moment where something is about to happen, just happened, or hangs "
            "in the air. Lean into atmospheric vocabulary that does the emotional work:\n"
            "- Light: low sun, hard shadow, a single lamp, fog through which a beam cuts, "
            "headlights through rain\n"
            "- Surface: rain on glass, fingerprints on metal, dust in air, breath in cold\n"
            "- Composition: shallow depth of field with the subject in sharp focus, "
            "foreground or background framing the subject, low angle pushing the subject "
            "upward, off-center placement giving the eye somewhere to travel\n"
            "- Color: pick a palette that carries the mood — cold blue and amber for "
            "tension, warm gold and shadow for memory, desaturated grays for grief\n\n"
            "The image should feel like the most loaded second of a longer story. Avoid "
            "generic \"moody\" or \"dramatic\" output — the specifics of light, surface, "
            "composition, and color are what create the cinematic feel, not the words "
            "\"moody\" or \"dramatic\" themselves."
        ),
        "provocative": (
