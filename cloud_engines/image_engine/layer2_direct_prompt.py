...
INFOGRAPHIC_PROMPT_TEMPLATE = "infographic_prompt_v1"
DIRECT_PROMPT_TEMPLATES = frozenset({
    DIRECT_PROMPT_TEMPLATE,
    DIRECT_PROMPT_V2_TEMPLATE,
    DIRECT_PROMPT_V3_TEMPLATE,
})
BACKEND_TEMPLATES = frozenset({STRUCTURED_PLAN_TEMPLATE, INFOGRAPHIC_PROMPT_TEMPLATE, *DIRECT_PROMPT_TEMPLATES})
