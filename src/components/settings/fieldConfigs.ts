...
export const VIDEO_FIELDS: FieldDef[] = [
  ...
  { key: 'motion_speed', label: 'Motion Speed', type: 'dropdown', options: ['very_slow', 'slow', 'medium', 'fast'], optionLabels: { very_slow: 'Very Slow', slow: 'Slow', medium: 'Medium', fast: 'Fast' }, default: 'slow', condition: s => s.motion_type && s.motion_type !== 'auto' && s.motion_type !== 'static' },
  // kling
