...
KIE_WAN_PRO_COST_PER_IMAGE: float = 0.035
KIE_FLUX_PRO_COST_PER_IMAGE: float = 0.025
KIE_SEEDREAM_LITE_COST_PER_IMAGE: float = 0.027
KIE_GPT_IMAGE_2_COST_PER_IMAGE_2K: float = 0.050
KIE_Z_IMAGE_COST_PER_IMAGE: float = 0.004
FAL_ZTURBO_COST_PER_IMAGE: float = 0.010
FAL_Z_IMAGE_TURBO_COST_PER_IMAGE_LANDSCAPE_16_9: float = 0.003
FAL_Z_IMAGE_TURBO_COST_PER_IMAGE_FULL_HD: float = 0.010
