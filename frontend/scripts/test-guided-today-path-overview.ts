...
assert('Wistful lesson cards render selected image number assets', todayPathOverviewSource.includes("selectedVibeId === 'wistful'") && todayPathOverviewSource.includes('/guided/lesson-numbers/wistful/${paddedLessonNumber}.webp') && todayPathOverviewSource.includes('data-lesson-number-asset="wistful"'))
...
assert('Sharp lesson cards still fall back to text numbers', !lessonNumberMarkerSource.includes('/guided/lesson-numbers/sharp/') && lessonNumberMarkerSource.includes('return <>{lessonNumber}</>'))
