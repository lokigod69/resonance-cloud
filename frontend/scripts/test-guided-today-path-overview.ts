...
assert('segment review tiles show progress without changing 0/10 lesson completion count', todayPathOverviewSource.includes('progressLabel={`${completedCount}/5`}') && !todayPathOverviewSource.includes('totalLessons +'))
assert('segment review tiles use active vibe review assets', todayPathOverviewSource.includes('/guided/reviews/${selectedVibeId}-review.webp'))
