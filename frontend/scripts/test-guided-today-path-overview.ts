...
assert('Wistful lesson cards render selected image number assets for lessons 1-5', lessonNumberMarkerSource.includes("selectedVibeId === 'wistful'") && lessonNumberMarkerSource.includes('lessonNumber <= 5') && lessonNumberMarkerSource.includes('/guided/lesson-numbers/wistful/${paddedLessonNumber}.webp') && lessonNumberMarkerSource.includes('data-lesson-number-asset="wistful"'))
assert('Sharp lesson cards render selected image number assets for lessons 1-5', lessonNumberMarkerSource.includes("selectedVibeId === 'sharp'") && lessonNumberMarkerSource.includes('lessonNumber <= 5') && lessonNumberMarkerSource.includes('/guided/lesson-numbers/sharp/${paddedLessonNumber}.webp') && lessonNumberMarkerSource.includes('data-lesson-number-asset="sharp"'))
assert('Sharp lesson cards still fall back to text numbers after lesson 5', lessonNumberMarkerSource.includes('return <>{lessonNumber}</>'))
