...
const desktopRailAssetCss = sliceBetween(todayCssSource, '.today-path-desktopRailAsset {', '}')
...
assert('desktop path rail asset is positioned by the five-number grid', desktopSegmentGridSource.includes('today-path-desktopRailAsset') && segmentGridCss.includes('--today-node-size') && desktopRailAssetCss.includes('top: 50%') && desktopRailAssetCss.includes('transform: translateY(-50%)'), { desktopSegmentGridSource, segmentGridCss, desktopRailAssetCss })
