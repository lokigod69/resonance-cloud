...
assert('trophy lyric column titles use translation registry', !trophySongPanelSource.includes('English lyrics') && !trophySongPanelSource.includes('German translation') && trophySongPanelSource.includes("t('music.lyrics.original')") && trophySongPanelSource.includes("t('today.trophy.lyrics.baseTitle')"))
...
assert('checkpoint uses base-neutral cloze cues and resolver', checkpointSource.includes('today.checkpoint.baseCue') && checkpointSource.includes('today.checkpoint.segmentTypePrompt') && checkpointSource.includes('resolveGuidedBaseContent') && !checkpointSource.includes('today.checkpoint.germanCue') && !checkpointSource.includes('today.checkpoint.germanPrompt'))
assert('trophy word card resolves meaning with preferred and authored base languages', trophyWordCardSource.includes('resolveGuidedBaseContent') && trophyWordCardSource.includes('preferredBaseLanguage: profile?.base_language') && trophyWordCardSource.includes('authoredBaseLanguage,'))
