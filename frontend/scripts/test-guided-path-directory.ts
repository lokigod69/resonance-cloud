...
const todayLanguageSource = readSource('../src/lib/todayLanguage.ts')
...
assert('translations include Polish language labels instead of falling back to raw keys', translationsSource.includes("'today.language.Polish': 'Polish'") && translationsSource.includes("'today.language.Polish': 'Polnisch'") && translationsSource.includes("'today.language.Polish': 'polonais'"), translationsSource)
