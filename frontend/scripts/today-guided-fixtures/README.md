...
fixture matrix covers 320, 390, and 1440 pixel overviews; Japanese, Korean,
Polish, and German long/short practice tiles at each width; measured text and
viewport containment; the open, unframed selected-answer area; visible progress;
checkpoint pending, wrong, and summary states at each width;
direct lower-lesson
