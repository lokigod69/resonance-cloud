...
export function GuidedVibePicker({
  ...
  if (compact) {
    return (
      ...
      >
        <p className="today-vibe-pickerCompactLabel text-xs font-semibold text-[var(--text-secondary)]">
          {t('today.vibePicker.compactLabel')}
        </p>

        <div className="today-vibe-pickerOptions mt-2 grid gap-2">
