...
export const IMAGE_FIELDS: FieldDef[] = [
  ...
  { key: 'image_model', label: 'Image Model', type: 'dropdown', options: ['fast', 'quality', 'wan_fast', 'wan_quality'], default: 'quality', optionLabels: { fast: 'Gemini Flash', quality: 'Gemini Pro', wan_fast: 'Wan 2.7', wan_quality: 'Wan 2.7 Pro' } },
