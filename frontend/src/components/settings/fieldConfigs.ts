...
export const VIDEO_FIELDS: FieldDef[] = [
  ...
  { key: 'frame_transitions', label: 'Frame Transitions', type: 'toggle', default: false, helper: 'Enable transitions between frames', condition: isLtx },
  { key: 'transition_mode', label: 'Transition Mode', type: 'dropdown', options: ['all_cut', 'morph_then_cut', 'cut_then_morph', 'all_morph', 'auto'], optionLabels: { all_cut: 'All Cut', morph_then_cut: 'Morph then Cut', cut_then_morph: 'Cut then Morph', all_morph: 'All Morph', auto: 'Auto' }, default: 'all_cut', helper: 'How scenes connect: morphing transitions or hard cuts', condition: (s: Record<string, unknown>) => isLtx(s) && s.frame_transitions === true },
