...
function Toolbar({
  ...
  return (
    <div ref={toolbarRef} data-toolbar className="sticky top-0 md:absolute md:top-0 left-0 right-0 z-40 flex flex-wrap items-center justify-start gap-2 px-3 py-2 sm:gap-3 sm:px-4 sm:py-3 bg-[#0a0a0a]/40">
      <button
        onClick={(event) => {
          event.stopPropagation()
          onExit()
...
function RevealModal({
  ...
  return (
    ...
    >
      ...
      <div
        data-phase-g-modal
        className="relative flex flex-col w-full mx-auto max-h-[85vh] bg-[#080808] border border-[#222] rounded-lg overflow-hidden zen-modal-enter"
      ...
      >
        ...
        <div
          ...
          className="sticky top-0 z-10 flex-shrink-0 bg-[#080808] px-6 pb-3 pt-12 text-center md:px-10"
        >
          <button
            type="button"
            onClick={onSpeak}
