...
function Toolbar({
  ...
  return (
    <div
      ref={toolbarRef}
      data-toolbar
      className="sticky top-0 md:absolute md:top-0 left-0 right-0 z-40 flex flex-wrap items-center justify-start gap-2 py-2 pr-3 sm:gap-3 sm:py-3 sm:pr-4 bg-black/50 border-b border-[#00fff2]/20 font-mono"
      style={{
