          ...
          >
            ...
            {imageUrl && (
              <div className="mb-6 flex justify-center">
                <div className="relative w-[140px] md:w-[160px] aspect-video overflow-hidden rounded-lg border border-[#a8d8ea]/30">
                  <div
                    className={`absolute inset-0 animate-pulse bg-cyan-950/40 transition-opacity duration-300 ${imageLoaded ? 'opacity-0' : 'opacity-100'}`}
                    aria-hidden="true"
                  />
                  <img
                    src={imageUrl}
