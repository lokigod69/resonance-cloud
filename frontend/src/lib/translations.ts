...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dashboard.levelTooltip': '{count} words learned — every 10 words = 1 level',
  ...
  de: {
    ...
    'dashboard.deckCount.other': '{count} Decks',
    'dashboard.credits': '{count} Credits',
    'dashboard.levelTooltip': '{count} Wörter gelernt — alle 10 Wörter = 1 Level',
  ...
  fr: {
    ...
    'dashboard.levelTooltip': '{count} mots appris — tous les 10 mots = 1 niveau',
