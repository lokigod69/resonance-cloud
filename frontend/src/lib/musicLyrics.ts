...
export function extractMusicLyrics({
  ...
  const musicDisplayLyrics = cleanText(musicLyricsRow?.display_lyrics)
  if (musicDisplayLyrics) {
    return {
      lyrics: musicDisplayLyrics,
      source: 'music_lyrics.display_lyrics',
    }
  }
