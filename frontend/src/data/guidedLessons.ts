  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('decided', 'entschieden', 'Decided: this one.', 'Decided hält Sharps Wahlmoment knapp und abgeschlossen.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        typeRecall: recall('', 'In stock', '?', ['In stock', 'have this', 'certain', 'where']),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        typeRecall: recall('Would ', 'card', ' be okay?', ['card', 'cash', 'again', 'pay by card']),
  ...
  },
  {
    ...
    variants: {
      bright: createA1P2VariantInput({
        ...
        typeRecall: recall('Could I get a ', 'receipt', ' and a bag?', ['receipt', 'bag', 'card', 'splendid']),
