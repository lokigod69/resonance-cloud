...
const GUIDED_TODAY_PATH_SPANISH_TWO_METADATA: GuidedPathMetadata = {
  id: 'spanish-a1-practical-2',
  title: 'Spanish A1 Practical 2',
  shortTitle: 'A1 Practical 2',
  subtitle: 'Kleine Hilfe und einfache Entscheidungen',
  level: 'A1',
  baseLanguage: 'German',
  targetLanguage: 'Spanish',
  estimatedMinutes: 5,
...
const GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA: GuidedPathMetadata = {
  id: 'french-a1-practical-5',
  title: 'French A1 Practical 5',
  shortTitle: 'A1 Practical 5',
  subtitle: 'Kennenlernen und Pläne auf Französisch',
  level: 'A1',
  baseLanguage: 'German',
  targetLanguage: 'French',
  estimatedMinutes: 5,
...
const GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA: GuidedPathMetadata = {
  id: 'french-a1-practical-8',
  title: 'French A1 Practical 8',
  shortTitle: 'A1 Practical 8',
  subtitle: 'Hotel und Unterkunft auf Französisch',
  level: 'A1',
  baseLanguage: 'German',
  targetLanguage: 'French',
  estimatedMinutes: 5,
...
const GUIDED_TODAY_PATH_FRENCH_NINE_METADATA: GuidedPathMetadata = {
  id: 'french-a1-practical-9',
  title: 'French A1 Practical 9',
  shortTitle: 'A1 Practical 9',
  subtitle: 'Treffen und Pläne auf Französisch',
  level: 'A1',
  baseLanguage: 'German',
  targetLanguage: 'French',
  estimatedMinutes: 5,
...
const GUIDED_TODAY_PATH_FRENCH_TEN_METADATA: GuidedPathMetadata = {
  id: 'french-a1-practical-10',
  title: 'French A1 Practical 10',
  shortTitle: 'A1 Practical 10',
  subtitle: 'Abschluss und Abschied auf Französisch',
  level: 'A1',
  baseLanguage: 'German',
  targetLanguage: 'French',
  estimatedMinutes: 5,
...
const brightLesson002: GuidedLessonVibeVariant = {
  contentStatus: "draft",
  corePhrase: {
    targetText: "Sorry, could you say that again?",
    baseText: "Entschuldigung, könnten Sie das noch einmal sagen?",
  },
  meaning: "Eine warme Bitte, etwas noch einmal zu hören.",
  chunks: [
  ...
  build: {
    targetText: "Sorry, could you say that again?",
    chips: ["Sorry,", "could you say that", "again?", "marvelous"],
  },
  typeRecall: {
  ...
  speakTarget: {
    baseCue: "Entschuldigung, könnten Sie das noch einmal sagen?",
    targetPhrase: "Sorry, could you say that again?",
    language: "en-US",
    passingThreshold: 0.8,
  },
  sceneCaption: "Die Nachfrage bleibt hell: kurz bitten, klar bleiben, weiter zuhören.",
  trophyWord: {
    word: "marvelous",
    meaning: "großartig",
  ...
  placeholderMedia: {
    type: "video",
    caption: "Helles Café, Barista wiederholt geduldig, die Bitte bleibt kurz und freundlich.",
  },
  songSeed: {
...
const brightLesson004: GuidedLessonVibeVariant = {
  contentStatus: "draft",
  corePhrase: {
    targetText: "I'd like a coffee, please.",
    baseText: "Ich hätte gern einen Kaffee, bitte.",
  },
  meaning: "Eine freundliche Bestellung, klar und höflich.",
  chunks: [
    { id: "id-like", targetText: "I'd like", baseText: "ich hätte gern" },
    { id: "a-coffee", targetText: "a coffee", baseText: "einen Kaffee" },
    { id: "please", targetText: "please", baseText: "bitte" },
  ],
  lessonItems: [
    { id: "id-like", targetText: "I'd like", baseText: "ich hätte gern", acceptedAnswers: ["I'd like", "I would like", "id like"] },
  ...
  build: {
    targetText: "I'd like a coffee, please.",
    chips: ["I'd like", "a coffee,", "please.", "eager", "ready"],
  },
  typeRecall: {
    before: "I'd like a ",
    answer: "coffee",
  ...
  speakTarget: {
    baseCue: "Ich hätte gern einen Kaffee, bitte.",
    targetPhrase: "I'd like a coffee, please.",
    language: "en-US",
    passingThreshold: 0.8,
  },
...
const brightLesson005: GuidedLessonVibeVariant = {
  ...
  meaning: "Eine klare Preisfrage im Laden.",
  chunks: [
  ...
  build: {
    targetText: "How much is this?",
    chips: ["How much", "is this?", "splendid"],
  },
  typeRecall: {
    before: "",
    answer: "How much",
  ...
  sceneCaption: "Im Laden fragt Bright hell und direkt nach dem Preis.",
  trophyWord: {
    word: "splendid",
    meaning: "großartig",
  ...
  placeholderMedia: {
    type: "video",
    caption: "Sonniger Laden, klares Preisschild, kurze Frage vor der Entscheidung.",
  },
  songSeed: {
    genre: "sunny indie pop",
...
const brightLesson006: GuidedLessonVibeVariant = {
  ...
  corePhrase: {
    ...
    baseText: "Hallo, wann fährt der Zug?",
  },
  ...
  speakTarget: {
    baseCue: "Hallo, wann fährt der Zug?",
...
const brightLesson009: GuidedLessonVibeVariant = {
  ...
  chunks: [
    ...
    { id: "great", targetText: "Great", baseText: "großartig" },
  ],
  lessonItems: [
    ...
    { id: "great", targetText: "great", baseText: "großartig", acceptedAnswers: ["great"] },
  ...
  speakTarget: {
    baseCue: "Morgen um sieben? Großartig!",
  ...
  trophyWord: {
    ...
    whyThisWord: "Great ist Brights kurze, natürliche Zusage für einen einfachen Plan.",
  },
  placeholderMedia: {
    type: "video",
...
const brightLesson010: GuidedLessonVibeVariant = {
  contentStatus: "draft",
  corePhrase: {
    targetText: "Wonderful, thanks so much. Goodbye.",
  ...
  build: {
    targetText: "Wonderful, thanks so much. Goodbye.",
    chips: ["Wonderful,", "thanks so much.", "Goodbye.", "lovely", "brilliant"],
  },
  typeRecall: {
    before: "",
    answer: "Wonderful",
  ...
  speakTarget: {
    baseCue: "Wunderbar, vielen Dank. Auf Wiedersehen.",
    targetPhrase: "Wonderful, thanks so much. Goodbye.",
    language: "en-US",
    passingThreshold: 0.8,
  },
  ...
  trophyWord: {
    word: "wonderful",
    meaning: "wunderbar",
    example: "Wonderful, thanks so much.",
    whyThisWord: "Wonderful ist hier Brights Abschlussanker: warm, klar und dankbar.",
  },
  placeholderMedia: {
    type: "video",
...
const brightSpanishP2Lesson002: GuidedLessonVibeVariant = {
  ...
  corePhrase: {
    ...
    baseText: 'Können Sie mir das bitte hier aufschreiben?',
  },
  meaning: 'Eine ruhige Bitte, eine genaue Angabe (Name, Adresse, Preis) hier aufzuschreiben.',
  chunks: [
    { id: 'me-lo-puede', targetText: '¿Me lo puede', baseText: 'Können Sie mir das' },
    { id: 'escribir-aqui', targetText: 'escribir aquí,', baseText: 'hier aufschreiben,' },
    { id: 'por-favor', targetText: 'por favor?', baseText: 'bitte?' },
  ],
  lessonItems: [
  ...
  typeRecall: {
    before: '¿Me lo puede ',
    answer: 'escribir',
    after: ' aquí, por favor?',
    acceptedAnswers: ['escribir', 'Escribir'],
    fallbackChoices: ['escribir', 'decir', 'repetir', 'enseñar'],
  },
  speakTarget: {
    baseCue: 'Können Sie mir das bitte hier aufschreiben?',
    targetPhrase: '¿Me lo puede escribir aquí, por favor?',
    language: 'es-ES',
    passingThreshold: 0.8,
    requiredTokens: ['me', 'puede', 'escribir', 'aquí', 'por', 'favor'],
    optionalTokens: ['lo', 'señora', 'señor'],
  },
  sceneCaption: 'An der Theke bittest du höflich darum, dass eine wichtige Angabe direkt aufgeschrieben wird.',
  trophyWord: {
    word: 'escribir',
...
const brightSpanishP2Lesson004: GuidedLessonVibeVariant = {
  ...
  chunks: [
    ...
    { id: 'este-o-ese', targetText: 'este o ese?', baseText: 'dieser oder jener?' },
  ],
  lessonItems: [
    ...
    { id: 'este', targetText: 'este', baseText: 'dieser (hier)', acceptedAnswers: ['este', 'éste', 'Este', 'Éste'] },
    { id: 'ese', targetText: 'ese', baseText: 'jener (da)', acceptedAnswers: ['ese', 'ése', 'Ese', 'Ése'] },
  ],
  build: {
    targetText: '¿Cuál es mejor, este o ese?',
  ...
  speakTarget: {
    ...
    targetPhrase: '¿Cuál es mejor, este o ese?',
    language: 'es-ES',
    passingThreshold: 0.8,
    requiredTokens: ['cuál', 'mejor', 'este', 'ese'],
  ...
  trophyWord: {
    word: 'mejor',
    meaning: 'besser',
    example: 'Este es mejor.',
    whyThisWord: 'Mejor ist auf A1 das einfache Vergleichswort und reicht für jede Wahl zwischen zwei sichtbaren Optionen. Demonstrativ-Pronomen este/ese stehen seit RAE 2010 ohne Akzent.',
  },
  placeholderMedia: {
    type: 'video',
...
const brightSpanishP2Lesson006: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: '¿Se puede pagar con tarjeta?',
    baseText: 'Kann man mit Karte zahlen?',
  },
  meaning: 'Eine direkte, unpersönliche Frage am Tresen, ob Kartenzahlung möglich ist — das natürliche Iberische Service-Register.',
  chunks: [
    { id: 'se-puede-pagar', targetText: '¿Se puede pagar', baseText: 'Kann man zahlen' },
    { id: 'con', targetText: 'con', baseText: 'mit' },
    { id: 'tarjeta', targetText: 'tarjeta?', baseText: 'Karte?' },
  ],
  lessonItems: [
    { id: 'se-puede', targetText: 'se puede', baseText: 'kann man (es geht)', acceptedAnswers: ['se puede', 'Se puede'] },
  ...
  build: {
    targetText: '¿Se puede pagar con tarjeta?',
    chips: ['¿Se puede pagar', 'con', 'tarjeta?', 'efectivo', 'por favor'],
  },
  typeRecall: {
    before: '¿Se puede pagar con ',
    answer: 'tarjeta',
    after: '?',
  ...
  speakTarget: {
    baseCue: 'Kann man mit Karte zahlen?',
    targetPhrase: '¿Se puede pagar con tarjeta?',
    language: 'es-ES',
    passingThreshold: 0.8,
  ...
  trophyWord: {
    ...
    whyThisWord: 'Tarjeta ist auf A1 das zentrale Zahlungswort in Spanien und öffnet jede Kassenfrage in Laden, Café oder Restaurant. Die unpersönliche se-Form ist im Iberischen Service-Register Standard.',
  },
  placeholderMedia: {
    type: 'video',
...
const brightSpanishP2Lesson007: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: '¿Me pone una bolsa y el recibo, por favor?',
    baseText: 'Können Sie mir eine Tüte und die Quittung geben, bitte?',
  },
  meaning: 'Eine kurze, höfliche Bitte um Tüte und Quittung am Ende eines kleinen Einkaufs.',
  chunks: [
    { id: 'me-pone', targetText: '¿Me pone', baseText: 'Können Sie mir geben' },
    { id: 'una-bolsa-y-el-recibo', targetText: 'una bolsa y el recibo,', baseText: 'eine Tüte und die Quittung,' },
    { id: 'por-favor', targetText: 'por favor?', baseText: 'bitte?' },
  ],
  lessonItems: [
  ...
  build: {
    targetText: '¿Me pone una bolsa y el recibo, por favor?',
    chips: ['¿Me pone', 'una bolsa', 'y el recibo,', 'por favor?', 'gracias'],
  },
  typeRecall: {
    before: '¿Me pone una ',
    answer: 'bolsa',
    after: ' y el recibo, por favor?',
    acceptedAnswers: ['bolsa', 'Bolsa'],
    fallbackChoices: ['bolsa', 'caja', 'mochila', 'cesta'],
  },
  speakTarget: {
    baseCue: 'Können Sie mir eine Tüte und die Quittung geben, bitte?',
    targetPhrase: '¿Me pone una bolsa y el recibo, por favor?',
    language: 'es-ES',
    passingThreshold: 0.8,
    requiredTokens: ['me', 'pone', 'bolsa', 'recibo', 'por', 'favor'],
    optionalTokens: ['una', 'el', 'y', 'señora', 'señor'],
  },
  sceneCaption: 'Beim Bezahlen hebst du die kleinen Einkäufe und bittest um Tüte und Quittung zum Mitnehmen.',
  trophyWord: {
    word: 'bolsa',
    meaning: 'Tüte / Tasche',
  ...
  placeholderMedia: {
    type: 'video',
    caption: 'Hand legt kleine Einkäufe auf den Tresen, eine Tüte rauscht über die Kante, Quittung folgt.',
  },
  songSeed: {
    genre: 'sunny acoustic',
    mood: 'small purchase wrap-up',
  },
  visualNotes: 'Tütendetail im warmen Licht, ruhige Übergabe-Geste, Quittung am Rand.',
}
...
const brightSpanishP2Lesson009: GuidedLessonVibeVariant = {
  ...
  chunks: [
    { id: 'es-este', targetText: '¿Es este', baseText: 'Ist das' },
  ...
  speakTarget: {
    ...
    targetPhrase: '¿Es este el correcto?',
    language: 'es-ES',
    passingThreshold: 0.8,
    requiredTokens: ['es', 'este', 'correcto'],
...
const brightFrenchP5Lesson001: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Désolé pour le retard.',
    baseText: 'Entschuldigung für die Verspätung.',
  },
  meaning: 'Eine kurze Entschuldigung, wenn du zu spät zu einem Treffen kommst.',
  chunks: [
    { id: 'desole', targetText: 'Désolé', baseText: 'Entschuldigung / tut mir leid' },
    { id: 'pour-le-retard', targetText: 'pour le retard.', baseText: 'für die Verspätung.' },
  ],
  lessonItems: [
    { id: 'desole', targetText: 'désolé', baseText: 'entschuldigung / tut mir leid', acceptedAnswers: ['désolé', 'desole', 'Désolé', 'Desole', 'désolée', 'desolee', 'Désolée', 'Desolee'] },
    { id: 'retard', targetText: 'retard', baseText: 'Verspätung', acceptedAnswers: ['retard', 'Retard'] },
    { id: 'pour-le-retard', targetText: 'pour le retard', baseText: 'für die Verspätung', acceptedAnswers: ['pour le retard', 'Pour le retard'] },
    { id: 'arrive', targetText: 'arrivé', baseText: 'angekommen', acceptedAnswers: ['arrivé', 'arrive', 'Arrivé', 'Arrive'] },
  ],
  build: {
    targetText: 'Désolé pour le retard.',
  ...
  sceneCaption: 'Du kommst zu spät an und entschuldigst dich knapp, bevor das Treffen weitergeht.',
  trophyWord: {
    word: 'retard',
    meaning: 'Verspätung',
    example: 'Désolé pour le retard.',
    whyThisWord: 'Retard ist hier die Verspätung, nicht ein Personenwort. Die feste Entschuldigung lautet natürlich "désolé pour le retard".',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Ankunft vor einem Café, kurzer entschuldigender Gruß.',
  },
  songSeed: {
    genre: 'soft acoustic',
    mood: 'arriving late but warm',
  },
  visualNotes: 'Café-Eingang, leichter Ankunftsmoment, freundliche Entschuldigung.',
}

const brightFrenchP5Lesson002: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "J'ai oublié mon téléphone.",
    baseText: 'Ich habe mein Telefon vergessen.',
  },
  meaning: 'Du sagst ruhig, dass du einen Gegenstand vergessen hast.',
  chunks: [
    { id: 'jai-oublie', targetText: "J'ai oublié", baseText: 'Ich habe vergessen' },
    { id: 'mon-telephone', targetText: 'mon téléphone.', baseText: 'mein Telefon.' },
  ],
  lessonItems: [
    { id: 'jai', targetText: "j'ai", baseText: 'ich habe', acceptedAnswers: ["j'ai", "J'ai", 'j’ai', 'J’ai', 'jai', 'Jai'] },
    { id: 'oublie', targetText: 'oublié', baseText: 'vergessen', acceptedAnswers: ['oublié', 'oublie', 'Oublié', 'Oublie'] },
    { id: 'telephone', targetText: 'téléphone', baseText: 'Telefon', acceptedAnswers: ['téléphone', 'telephone', 'Téléphone', 'Telephone'] },
    { id: 'mon-telephone', targetText: 'mon téléphone', baseText: 'mein Telefon', acceptedAnswers: ['mon téléphone', 'mon telephone', 'Mon téléphone', 'Mon telephone'] },
  ],
  build: {
    targetText: "J'ai oublié mon téléphone.",
    chips: ["J'ai oublié", 'mon téléphone.', 'ce soir', 'excuse-moi'],
  },
  typeRecall: {
    before: "J'ai ",
    answer: 'oublié',
    after: ' mon téléphone.',
    acceptedAnswers: ['oublié', 'oublie', 'Oublié', 'Oublie'],
    fallbackChoices: ['oublié', 'habites', 'viens', 'retard'],
  },
  speakTarget: {
    baseCue: 'Ich habe mein Telefon vergessen.',
  ...
  sceneCaption: 'Mitten im Gespräch merkst du, dass dein Telefon fehlt, und sagst es einfach.',
  trophyWord: {
    word: 'oublié',
    meaning: 'vergessen',
    example: "J'ai oublié mon téléphone.",
    whyThisWord: 'Oublié steht in der A1-natürlichen Form mit "j’ai". Die Elision ist Pflicht: "je ai" wäre falsch.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Tisch, suchende Hand in der Tasche, kurzer Satz über das vergessene Telefon.',
  },
  songSeed: {
    genre: 'light acoustic',
    mood: 'small mistake',
  },
  visualNotes: 'Tasche, leerer Platz fürs Telefon, ruhiger Pannenmoment.',
}

const brightFrenchP5Lesson003: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Quel est ton prénom ?',
    baseText: 'Wie ist dein Vorname?',
  },
  meaning: 'Eine einfache informelle Frage nach dem Vornamen in einer lockeren Begegnung.',
  chunks: [
    { id: 'quel-est', targetText: 'Quel est', baseText: 'Wie ist' },
    { id: 'ton-prenom', targetText: 'ton prénom ?', baseText: 'dein Vorname?' },
  ],
  lessonItems: [
    { id: 'quel', targetText: 'quel', baseText: 'welcher / wie', acceptedAnswers: ['quel', 'Quel'] },
    { id: 'ton', targetText: 'ton', baseText: 'dein', acceptedAnswers: ['ton', 'Ton'] },
    { id: 'prenom', targetText: 'prénom', baseText: 'Vorname', acceptedAnswers: ['prénom', 'prenom', 'Prénom', 'Prenom'] },
    { id: 'ton-prenom', targetText: 'ton prénom', baseText: 'dein Vorname', acceptedAnswers: ['ton prénom', 'ton prenom', 'Ton prénom', 'Ton prenom'] },
  ],
  build: {
    targetText: 'Quel est ton prénom ?',
  ...
  sceneCaption: 'In einer lockeren Vorstellung fragst du mit tu nach dem Vornamen.',
  trophyWord: {
    word: 'prénom',
    meaning: 'Vorname',
    example: 'Quel est ton prénom ?',
    whyThisWord: 'Prénom ist der Vorname. Das "ton" zeigt bewusst die informelle tu-Schiene; bei Personal oder Fremden im Service wäre "votre prénom" höflicher.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Lockeres erstes Gespräch, Namensfrage ohne Service-Distanz.',
  },
  songSeed: {
    genre: 'bright acoustic',
    mood: 'first names',
  },
  visualNotes: 'Zwei Personen im Gespräch, heller sozialer Einstieg.',
}

const brightFrenchP5Lesson004: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Enchanté.',
    baseText: 'Freut mich.',
  },
  meaning: 'Eine feste freundliche Antwort nach einer Vorstellung.',
  chunks: [
    { id: 'enchante', targetText: 'Enchanté.', baseText: 'Freut mich.' },
  ],
  lessonItems: [
    { id: 'enchante', targetText: 'enchanté', baseText: 'erfreut / freut mich', acceptedAnswers: ['enchanté', 'enchante', 'Enchanté', 'Enchante', 'enchantée', 'enchantee', 'Enchantée', 'Enchantee'] },
    { id: 'moi-aussi', targetText: 'moi aussi', baseText: 'ich auch', acceptedAnswers: ['moi aussi', 'Moi aussi'] },
    { id: 'bonjour', targetText: 'bonjour', baseText: 'guten Tag', acceptedAnswers: ['bonjour', 'Bonjour'] },
    { id: 'salut', targetText: 'salut', baseText: 'hallo / tschüss', acceptedAnswers: ['salut', 'Salut'] },
  ],
  build: {
    targetText: 'Enchanté.',
    chips: ['Enchanté.', 'au revoir', 'ce soir'],
  },
  typeRecall: {
    before: '',
    answer: 'Enchanté',
    after: '.',
    acceptedAnswers: ['Enchanté', 'Enchanté.', 'enchanté', 'enchante', 'Enchante', 'Enchantée', 'enchantée', 'enchantee', 'Enchantee'],
  ...
  sceneCaption: 'Nach dem Namen antwortest du freundlich mit der festen Formel.',
  trophyWord: {
    word: 'enchanté',
    meaning: 'freut mich',
    example: 'Enchanté.',
    whyThisWord: 'Enchanté ist die feste A1-Formel nach einer Vorstellung. Eine Sprecherin schreibt oft "enchantée"; die Aussprache bleibt gleich.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Kurzes Lächeln nach der Vorstellung, freundliche feste Antwort.',
  },
  songSeed: {
    genre: 'warm acoustic',
    mood: 'nice to meet you',
  },
  visualNotes: 'Vorstellungsmoment, weiches Licht, einfache freundliche Antwort.',
}

const brightFrenchP5Lesson005: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Tu viens d'où ?",
    baseText: 'Woher kommst du?',
  },
  meaning: 'Eine informelle Frage nach Herkunft in einem lockeren Gespräch.',
  chunks: [
    { id: 'tu-viens', targetText: 'Tu viens', baseText: 'Du kommst' },
    { id: 'dou', targetText: "d'où ?", baseText: 'woher?' },
  ],
  lessonItems: [
    { id: 'tu', targetText: 'tu', baseText: 'du', acceptedAnswers: ['tu', 'Tu'] },
    { id: 'viens', targetText: 'viens', baseText: 'kommst', acceptedAnswers: ['viens', 'Viens'] },
    { id: 'dou', targetText: "d'où", baseText: 'woher', acceptedAnswers: ["d'où", "D'où", 'd’ou', 'D’ou', 'd ou', 'D ou'] },
    { id: 'tu-viens', targetText: 'tu viens', baseText: 'du kommst', acceptedAnswers: ['tu viens', 'Tu viens'] },
  ],
  build: {
    targetText: "Tu viens d'où ?",
  ...
  sceneCaption: 'Im lockeren Gespräch fragst du nach Herkunft und bleibst bei tu.',
  trophyWord: {
    word: 'viens',
    meaning: 'du kommst',
    example: "Tu viens d'où ?",
    whyThisWord: 'Viens ist die tu-Form von venir. Die Frage ist informell; in höflicher Distanz wäre "vous venez d’où ?" passender.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Locker stehendes Gespräch, kurze Frage nach Herkunft.',
  },
  songSeed: {
    genre: 'light social acoustic',
    mood: 'getting to know someone',
  },
  visualNotes: 'Zwei Gesprächspartner, offene Körpersprache, kleine Herkunftsfrage.',
}

const brightFrenchP5Lesson006: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Tu habites à Paris ?',
    baseText: 'Wohnst du in Paris?',
  },
  meaning: 'Eine informelle Frage, ob die Person an einem Ort wohnt.',
  chunks: [
    { id: 'tu-habites', targetText: 'Tu habites', baseText: 'Du wohnst' },
    { id: 'a-paris', targetText: 'à Paris ?', baseText: 'in Paris?' },
  ],
  lessonItems: [
    { id: 'habites', targetText: 'habites', baseText: 'wohnst', acceptedAnswers: ['habites', 'Habites', 'habite', 'Habite'] },
    { id: 'paris', targetText: 'Paris', baseText: 'Paris', acceptedAnswers: ['Paris', 'paris'] },
    { id: 'a-paris', targetText: 'à Paris', baseText: 'in Paris', acceptedAnswers: ['à Paris', 'a Paris', 'À Paris', 'A Paris'] },
    { id: 'tu-habites', targetText: 'tu habites', baseText: 'du wohnst', acceptedAnswers: ['tu habites', 'Tu habites', 'tu habite', 'Tu habite'] },
  ],
  build: {
    targetText: 'Tu habites à Paris ?',
    chips: ['Tu habites', 'à Paris ?', 'd’où', 'ce soir'],
  },
  typeRecall: {
    before: 'Tu ',
    answer: 'habites',
    after: ' à Paris ?',
    acceptedAnswers: ['habites', 'Habites', 'habite', 'Habite'],
    fallbackChoices: ['habites', 'viens', 'oublié', 'revoir'],
  },
  speakTarget: {
    baseCue: 'Wohnst du in Paris?',
  ...
  sceneCaption: 'Nach der Herkunft fragst du locker, ob die Person in Paris wohnt.',
  trophyWord: {
    word: 'habites',
    meaning: 'du wohnst',
    example: 'Tu habites à Paris ?',
    whyThisWord: 'Habites ist die tu-Form von habiter. Das End-s ist schriftlich wichtig, auch wenn es in der Aussprache meist nicht hörbar ist.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Locker sitzendes Gespräch, Ortsfrage über Paris.',
  },
  songSeed: {
    genre: 'warm acoustic',
    mood: 'local question',
  },
  visualNotes: 'Stadtkarte im Hintergrund, informelle Wohnortfrage.',
}

const brightFrenchP5Lesson007: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Tu es libre ce soir ?',
    baseText: 'Hast du heute Abend Zeit?',
  },
  meaning: 'Eine informelle Frage nach Zeit oder Verfügbarkeit am Abend.',
  chunks: [
    { id: 'tu-es-libre', targetText: 'Tu es libre', baseText: 'Du bist frei / hast Zeit' },
    { id: 'ce-soir', targetText: 'ce soir ?', baseText: 'heute Abend?' },
  ],
  lessonItems: [
    ...
    { id: 'ce-soir', targetText: 'ce soir', baseText: 'heute Abend', acceptedAnswers: ['ce soir', 'Ce soir'] },
    { id: 'tu-es', targetText: 'tu es', baseText: 'du bist', acceptedAnswers: ['tu es', 'Tu es'] },
  ],
  build: {
    targetText: 'Tu es libre ce soir ?',
    chips: ['Tu es libre', 'ce soir ?', 'demain', 's’il te plaît'],
  },
  typeRecall: {
    before: 'Tu es libre ce ',
    answer: 'soir',
    after: ' ?',
  ...
  sceneCaption: 'Am Ende des Tages fragst du locker, ob die andere Person heute Abend Zeit hat.',
  trophyWord: {
    word: 'soir',
    meaning: 'Abend',
    example: 'Tu es libre ce soir ?',
    whyThisWord: 'Soir ist der Abend. "Ce soir" ist die feste A1-Gruppe für "heute Abend".',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Abendliches Gespräch vor einem Café, lockere Verfügbarkeitsfrage.',
  },
  songSeed: {
    genre: 'evening acoustic',
    mood: 'checking plans',
  },
  visualNotes: 'Abendlicht, lockere Planung, kurzer sozialer Check.',
}

const brightFrenchP5Lesson008: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'On se voit au parc ?',
    baseText: 'Treffen wir uns im Park?',
  },
  meaning: 'Ein einfacher informeller Vorschlag für einen konkreten Treffpunkt.',
  chunks: [
    { id: 'on-se-voit', targetText: 'On se voit', baseText: 'Wir sehen uns / treffen uns' },
    { id: 'au-parc', targetText: 'au parc ?', baseText: 'im Park?' },
  ],
  lessonItems: [
    { id: 'on-se-voit', targetText: 'on se voit', baseText: 'wir treffen uns', acceptedAnswers: ['on se voit', 'On se voit'] },
    { id: 'parc', targetText: 'parc', baseText: 'Park', acceptedAnswers: ['parc', 'Parc'] },
    { id: 'au-parc', targetText: 'au parc', baseText: 'im Park', acceptedAnswers: ['au parc', 'Au parc'] },
    { id: 'voir', targetText: 'voir', baseText: 'sehen', acceptedAnswers: ['voir', 'Voir'] },
  ],
  build: {
    targetText: 'On se voit au parc ?',
  ...
  sceneCaption: 'Du schlägst locker einen Treffpunkt vor: im Park.',
  trophyWord: {
    word: 'parc',
    meaning: 'Park',
    example: 'On se voit au parc ?',
    whyThisWord: 'Parc ist ein einfacher A1-Ort für Treffen. "Au parc" zeigt die Pflichtform à + le = au.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Parkeingang als Treffpunkt, lockerer Vorschlag im Gespräch.',
  },
  songSeed: {
    genre: 'sunny acoustic',
    mood: 'meeting at the park',
  },
  visualNotes: 'Parktor, heller Treffpunkt, leichter Planungssatz.',
}

const brightFrenchP5Lesson009: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Peut-être demain ?',
    baseText: 'Vielleicht morgen?',
  },
  meaning: 'Eine weiche informelle Verschiebung, wenn der Plan heute nicht passt.',
  chunks: [
    { id: 'peut-etre', targetText: 'Peut-être', baseText: 'Vielleicht' },
    { id: 'demain', targetText: 'demain ?', baseText: 'morgen?' },
  ],
  lessonItems: [
    { id: 'peut-etre', targetText: 'peut-être', baseText: 'vielleicht', acceptedAnswers: ['peut-être', 'Peut-être', 'peut etre', 'Peut etre'] },
    { id: 'demain', targetText: 'demain', baseText: 'morgen', acceptedAnswers: ['demain', 'Demain'] },
    { id: 'pas-ce-soir', targetText: 'pas ce soir', baseText: 'nicht heute Abend', acceptedAnswers: ['pas ce soir', 'Pas ce soir'] },
    { id: 'daccord', targetText: "d'accord", baseText: 'einverstanden', acceptedAnswers: ["d'accord", "D'accord", 'd’accord', 'D’accord', 'd accord', 'D accord'] },
  ],
  build: {
    targetText: 'Peut-être demain ?',
    chips: ['Peut-être', 'demain ?', 'ce soir', 'au parc'],
  },
  typeRecall: {
    before: '',
    answer: 'Peut-être',
    after: ' demain ?',
    acceptedAnswers: ['Peut-être', 'peut-être', 'Peut etre', 'peut etre'],
  ...
  sceneCaption: 'Du kannst jetzt nicht fest zusagen und schlägst weich morgen vor.',
  trophyWord: {
    word: 'peut-être',
    meaning: 'vielleicht',
    example: 'Peut-être demain ?',
    whyThisWord: 'Peut-être macht eine Verschiebung weich. Es ist eine feste Schreibung mit Bindestrich; ohne Akzent und Bindestrich bleibt es als Tippvariante erkennbar.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Locker verschobener Plan, freundlicher Blick auf den nächsten Tag.',
  },
  songSeed: {
    genre: 'soft evening acoustic',
    mood: 'postponing gently',
  },
  visualNotes: 'Abendliche Straße, kleiner Planwechsel, offener Ton.',
}

const brightFrenchP5Lesson010: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'À demain, au revoir.',
    baseText: 'Bis morgen, auf Wiedersehen.',
  },
  meaning: 'Ein klarer Abschied nach einem lockeren Treffen mit Blick auf morgen.',
  chunks: [
    { id: 'a-demain', targetText: 'À demain,', baseText: 'Bis morgen,' },
    { id: 'au-revoir', targetText: 'au revoir.', baseText: 'auf Wiedersehen.' },
  ],
  lessonItems: [
    { id: 'a-demain', targetText: 'à demain', baseText: 'bis morgen', acceptedAnswers: ['à demain', 'a demain', 'À demain', 'A demain'] },
    { id: 'revoir', targetText: 'revoir', baseText: 'wiedersehen', acceptedAnswers: ['revoir', 'Revoir'] },
    { id: 'au-revoir', targetText: 'au revoir', baseText: 'auf Wiedersehen', acceptedAnswers: ['au revoir', 'Au revoir'] },
    { id: 'salut', targetText: 'salut', baseText: 'tschüss / hallo', acceptedAnswers: ['salut', 'Salut'] },
  ],
  build: {
    targetText: 'À demain, au revoir.',
    chips: ['À demain,', 'au revoir.', 'peut-être', 'un billet'],
  },
  typeRecall: {
    before: 'À demain, au ',
    answer: 'revoir',
  ...
  sceneCaption: 'Am Ende des Treffens verabschiedest du dich mit einem klaren Bis-morgen.',
  trophyWord: {
    word: 'revoir',
    meaning: 'wiedersehen',
    example: 'Au revoir.',
    whyThisWord: 'Revoir steckt in "au revoir", dem Standardabschied. Das Wort trägt die Idee des Wiedersehens; die Phrase bleibt auch in lockeren Situationen höflich.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Abschied vor dem Café, kurzer Plan für morgen bleibt stehen.',
  },
  songSeed: {
    genre: 'warm farewell acoustic',
    mood: 'see you tomorrow',
  },
...
const brightFrenchP8Lesson001: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "J'ai une réservation à l'hôtel.",
    baseText: 'Ich habe eine Reservierung im Hotel.',
  },
  meaning: 'Eine höfliche Eröffnung beim Check-in mit klarem Hotelkontext.',
  chunks: [
    { id: 'jai-une-reservation', targetText: "J'ai une réservation", baseText: 'Ich habe eine Reservierung' },
    { id: 'a-lhotel', targetText: "à l'hôtel.", baseText: 'im Hotel.' },
  ],
  lessonItems: [
    { id: 'hotel', targetText: 'hôtel', baseText: 'Hotel', acceptedAnswers: ['hôtel', 'hotel', 'Hôtel', 'Hotel'] },
    { id: 'lhotel', targetText: "l'hôtel", baseText: 'das Hotel', acceptedAnswers: ["l'hôtel", "L'hôtel", 'l’hôtel', 'L’hôtel', 'l hotel', 'L hotel'] },
    { id: 'reservation', targetText: 'réservation', baseText: 'Reservierung', acceptedAnswers: ['réservation', 'reservation', 'Réservation', 'Reservation'] },
    { id: 'jai-une-reservation', targetText: "j'ai une réservation", baseText: 'ich habe eine Reservierung', acceptedAnswers: ["j'ai une réservation", "J'ai une réservation", 'j’ai une réservation', 'J’ai une réservation', 'jai une reservation', 'Jai une reservation'] },
  ],
  build: {
    targetText: "J'ai une réservation à l'hôtel.",
    chips: ["J'ai une réservation", "à l'hôtel.", 'un ticket', 'de l’eau'],
  },
  typeRecall: {
    before: "J'ai une réservation à l'",
    answer: 'hôtel',
    after: '.',
  ...
  speakTarget: {
    ...
    targetPhrase: "J'ai une réservation à l'hôtel.",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['réservation', 'hôtel'],
    optionalTokens: ['reservation', 'hotel', 'jai', 'j', 'ai', 'une', 'à', 'a', 'l'],
  },
  sceneCaption: 'An der Rezeption eröffnest du den Check-in mit deiner Reservierung.',
  trophyWord: {
    word: 'hôtel',
    meaning: 'Hotel',
    example: "J'ai une réservation à l'hôtel.",
    whyThisWord: 'Hôtel hat ein stummes h, deshalb steht l’hôtel mit Elision. Der Satz macht die Reservierung ausdrücklich hotelbezogen.',
  },
  placeholderMedia: {
    type: 'video',
    caption: 'Hotelrezeption, Check-in mit Reservierung.',
  },
  songSeed: { genre: 'hotel lobby acoustic', mood: 'checking in' },
  visualNotes: 'Helle Rezeption, Gepäck, Check-in-Moment.',
}

const brightFrenchP8Lesson002: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Je voudrais une chambre, s'il vous plaît.",
    baseText: 'Ich hätte gern ein Zimmer, bitte.',
  },
  meaning: 'Eine höfliche Walk-in-Bitte nach einem Zimmer ohne vorherige Buchung.',
  chunks: [
    { id: 'je-voudrais', targetText: 'Je voudrais', baseText: 'Ich hätte gern' },
    { id: 'une-chambre', targetText: 'une chambre,', baseText: 'ein Zimmer,' },
    { id: 'sil-vous-plait', targetText: "s'il vous plaît.", baseText: 'bitte.' },
  ],
  lessonItems: [
    { id: 'chambre', targetText: 'chambre', baseText: 'Zimmer', acceptedAnswers: ['chambre', 'Chambre'] },
    { id: 'une-chambre', targetText: 'une chambre', baseText: 'ein Zimmer', acceptedAnswers: ['une chambre', 'Une chambre'] },
    { id: 'voudrais', targetText: 'je voudrais', baseText: 'ich hätte gern', acceptedAnswers: ['je voudrais', 'Je voudrais'] },
    { id: 'sil-vous-plait', targetText: "s'il vous plaît", baseText: 'bitte', acceptedAnswers: ["s'il vous plaît", "S'il vous plaît", "s'il vous plait", "S'il vous plait", 's’il vous plaît', 'S’il vous plaît', 's’il vous plait', 'S’il vous plait', 'sil vous plait'] },
  ],
  build: {
    targetText: "Je voudrais une chambre, s'il vous plaît.",
    chips: ['Je voudrais', 'une chambre,', "s'il vous plaît.", 'un café', 'ce train'],
  },
  typeRecall: {
    before: 'Je voudrais une ',
    answer: 'chambre',
    after: ", s'il vous plaît.",
  ...
  speakTarget: {
    ...
    targetPhrase: "Je voudrais une chambre, s'il vous plaît.",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['voudrais', 'chambre', 'plaît'],
    optionalTokens: ['je', 'une', 'sil', 's', 'il', 'vous', 'plait'],
  },
  sceneCaption: 'Ohne Buchung fragst du an der Rezeption höflich nach einem Zimmer.',
  trophyWord: {
    word: 'chambre',
    meaning: 'Zimmer',
    example: "Je voudrais une chambre, s'il vous plaît.",
    whyThisWord: 'Chambre ist im Hotel das Zimmer und ist feminin: une chambre.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotelrezeption, Walk-in-Anfrage nach einem Zimmer.' },
  songSeed: { genre: 'warm lobby acoustic', mood: 'asking for a room' },
  visualNotes: 'Rezeption, Koffer, einfache Zimmeranfrage.',
}

const brightFrenchP8Lesson003: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Ma chambre est à quel étage ?",
    baseText: 'Auf welcher Etage ist mein Zimmer?',
  },
  meaning: 'Eine einfache Nachfrage nach der Lage deines Zimmers nach dem Check-in.',
  chunks: [
    { id: 'ma-chambre-est', targetText: 'Ma chambre est', baseText: 'Mein Zimmer ist' },
    { id: 'a-quel-etage', targetText: 'à quel étage ?', baseText: 'auf welcher Etage?' },
  ],
  lessonItems: [
    { id: 'etage', targetText: 'étage', baseText: 'Etage', acceptedAnswers: ['étage', 'etage', 'Étage', 'Etage'] },
    { id: 'a-quel-etage', targetText: 'à quel étage', baseText: 'auf welcher Etage', acceptedAnswers: ['à quel étage', 'a quel étage', 'à quel etage', 'a quel etage', 'À quel étage', 'A quel etage'] },
    { id: 'ma-chambre', targetText: 'ma chambre', baseText: 'mein Zimmer', acceptedAnswers: ['ma chambre', 'Ma chambre'] },
    { id: 'est', targetText: 'est', baseText: 'ist', acceptedAnswers: ['est', 'Est'] },
  ],
  build: {
    targetText: "Ma chambre est à quel étage ?",
  ...
  speakTarget: {
    ...
    targetPhrase: "Ma chambre est à quel étage ?",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['chambre', 'quel', 'étage'],
    optionalTokens: ['ma', 'est', 'à', 'a', 'etage'],
  },
  sceneCaption: 'Nach dem Check-in fragst du nach der Etage deines Zimmers.',
  trophyWord: {
    word: 'étage',
    meaning: 'Etage',
    example: "Ma chambre est à quel étage ?",
    whyThisWord: 'Étage ist die Etage. Achtung: Im Französischen zählt man Stockwerke oft anders als im Deutschen; die Rezeption nennt die passende Etage.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotelrezeption mit Aufzug und Etagenanzeige.' },
  songSeed: { genre: 'light hotel acoustic', mood: 'finding the floor' },
  visualNotes: 'Aufzug, Rezeption, Etagenhinweis.',
}

const brightFrenchP8Lesson004: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "La clé de la chambre, s'il vous plaît.",
    baseText: 'Den Zimmerschlüssel, bitte.',
  },
  meaning: 'Eine knappe höfliche Bitte nach dem Zimmerschlüssel an der Rezeption.',
  chunks: [
    { id: 'la-cle-de-la-chambre', targetText: 'La clé de la chambre,', baseText: 'Den Schlüssel des Zimmers,' },
    { id: 'sil-vous-plait', targetText: "s'il vous plaît.", baseText: 'bitte.' },
  ],
  lessonItems: [
    { id: 'cle', targetText: 'clé', baseText: 'Schlüssel', acceptedAnswers: ['clé', 'cle', 'Clé', 'Cle'] },
    { id: 'la-cle', targetText: 'la clé', baseText: 'der Schlüssel', acceptedAnswers: ['la clé', 'la cle', 'La clé', 'La cle'] },
    { id: 'de-la-chambre', targetText: 'de la chambre', baseText: 'des Zimmers', acceptedAnswers: ['de la chambre', 'De la chambre'] },
    { id: 'chambre', targetText: 'chambre', baseText: 'Zimmer', acceptedAnswers: ['chambre', 'Chambre'] },
  ],
  build: {
    targetText: "La clé de la chambre, s'il vous plaît.",
    chips: ['La clé de la chambre,', "s'il vous plaît.", 'une serviette', 'à quel quai'],
  },
  typeRecall: {
    before: 'La ',
    answer: 'clé',
  ...
  speakTarget: {
    ...
    targetPhrase: "La clé de la chambre, s'il vous plaît.",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['clé', 'chambre', 'plaît'],
    optionalTokens: ['cle', 'la', 'de', 'sil', 's', 'il', 'vous', 'plait'],
  },
  sceneCaption: 'An der Rezeption bittest du knapp um den Zimmerschlüssel.',
  trophyWord: {
    word: 'clé',
    meaning: 'Schlüssel',
    example: "La clé de la chambre, s'il vous plaît.",
    whyThisWord: 'Clé ist feminin: la clé. Der Akzent ist im Zieltext Pflicht, auch wenn die Übung cle toleriert.',
  },
  placeholderMedia: { type: 'video', caption: 'Rezeption mit Zimmerschlüssel oder Schlüsselkarte.' },
  songSeed: { genre: 'hotel desk acoustic', mood: 'asking for the key' },
  visualNotes: 'Schlüsselkarte, Tresen, kurze Servicebitte.',
}

const brightFrenchP8Lesson005: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Il y a le Wi-Fi ici ?",
    baseText: 'Gibt es hier WLAN?',
  },
  meaning: 'Eine einfache Frage nach WLAN-Verfügbarkeit im Hotel.',
  chunks: [
    { id: 'il-y-a-le-wifi', targetText: 'Il y a le Wi-Fi', baseText: 'Gibt es WLAN' },
    { id: 'ici', targetText: 'ici ?', baseText: 'hier?' },
  ],
  lessonItems: [
    { id: 'wifi', targetText: 'Wi-Fi', baseText: 'WLAN', acceptedAnswers: ['Wi-Fi', 'wifi', 'wi-fi', 'Wifi', 'WIFI'] },
    { id: 'le-wifi', targetText: 'le Wi-Fi', baseText: 'das WLAN', acceptedAnswers: ['le Wi-Fi', 'le wifi', 'Le Wi-Fi', 'Le wifi'] },
    { id: 'il-y-a', targetText: 'il y a', baseText: 'es gibt', acceptedAnswers: ['il y a', 'Il y a'] },
    { id: 'ici', targetText: 'ici', baseText: 'hier', acceptedAnswers: ['ici', 'Ici'] },
  ],
  build: {
    targetText: "Il y a le Wi-Fi ici ?",
    chips: ['Il y a', 'le Wi-Fi', 'ici ?', 'une chambre', 'à demain'],
  },
  typeRecall: {
    before: 'Il y a le ',
    answer: 'Wi-Fi',
  ...
  speakTarget: {
    ...
    targetPhrase: "Il y a le Wi-Fi ici ?",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['wifi', 'ici'],
    optionalTokens: ['wi-fi', 'il', 'y', 'a', 'le'],
  },
  sceneCaption: 'In der Lobby oder im Zimmer fragst du, ob es WLAN gibt.',
  trophyWord: {
    word: 'Wi-Fi',
    meaning: 'WLAN',
    example: "Il y a le Wi-Fi ici ?",
    whyThisWord: 'Wi-Fi ist ein geliehenes Alltagswort. Die französische Aussprache kann variieren, deshalb sind die Spracherkennungsanker tolerant.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotellobby mit WLAN-Schild.' },
  songSeed: { genre: 'modern lobby acoustic', mood: 'asking for wifi' },
  visualNotes: 'WLAN-Schild, Rezeption, Smartphone.',
}

const brightFrenchP8Lesson006: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Où sont les toilettes, s'il vous plaît ?",
    baseText: 'Wo sind die Toiletten, bitte?',
  },
  meaning: 'Eine höfliche Frage nach der Toilette; Französisch nutzt hier meist den Plural.',
  chunks: [
    { id: 'ou-sont', targetText: 'Où sont', baseText: 'Wo sind' },
    { id: 'les-toilettes', targetText: 'les toilettes,', baseText: 'die Toiletten,' },
    { id: 'sil-vous-plait', targetText: "s'il vous plaît ?", baseText: 'bitte?' },
  ],
  lessonItems: [
    { id: 'toilettes', targetText: 'toilettes', baseText: 'Toiletten', acceptedAnswers: ['toilettes', 'Toilettes'] },
    { id: 'les-toilettes', targetText: 'les toilettes', baseText: 'die Toiletten', acceptedAnswers: ['les toilettes', 'Les toilettes'] },
    { id: 'ou-sont', targetText: 'où sont', baseText: 'wo sind', acceptedAnswers: ['où sont', 'ou sont', 'Où sont', 'Ou sont'] },
    { id: 'sont', targetText: 'sont', baseText: 'sind', acceptedAnswers: ['sont', 'Sont'] },
  ],
  build: {
    targetText: "Où sont les toilettes, s'il vous plaît ?",
    chips: ['Où sont', 'les toilettes,', "s'il vous plaît ?", 'ma chambre', 'un café'],
  },
  typeRecall: {
    before: 'Où sont les ',
    answer: 'toilettes',
    after: ", s'il vous plaît ?",
    acceptedAnswers: ['toilettes', 'Toilettes'],
    fallbackChoices: ['toilettes', 'serviettes', 'chambres', 'tables'],
  },
  speakTarget: {
    baseCue: 'Wo sind die Toiletten, bitte?',
    targetPhrase: "Où sont les toilettes, s'il vous plaît ?",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['toilettes', 'plaît'],
    optionalTokens: ['où', 'ou', 'sont', 'les', 'sil', 's', 'il', 'vous', 'plait'],
  },
  sceneCaption: 'Im Hotel oder Restaurant fragst du höflich nach den Toiletten.',
  trophyWord: {
    word: 'toilettes',
    meaning: 'Toiletten',
    example: "Où sont les toilettes, s'il vous plaît ?",
    whyThisWord: 'Französisch verwendet hier gewöhnlich den Plural: les toilettes, nicht le toilette.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotelflur mit Wegweiser zu den Toiletten.' },
  songSeed: { genre: 'light hallway acoustic', mood: 'asking directions indoors' },
  visualNotes: 'Hotelflur, dezenter WC-Wegweiser, höfliche Frage.',
}

const brightFrenchP8Lesson007: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Une serviette, s'il vous plaît.",
    baseText: 'Ein Handtuch, bitte.',
  },
  meaning: 'Eine knappe höfliche Bitte nach einem Handtuch im Hotel.',
  chunks: [
    { id: 'une-serviette', targetText: 'Une serviette,', baseText: 'Ein Handtuch,' },
    { id: 'sil-vous-plait', targetText: "s'il vous plaît.", baseText: 'bitte.' },
  ],
  lessonItems: [
    { id: 'serviette', targetText: 'serviette', baseText: 'Handtuch', acceptedAnswers: ['serviette', 'Serviette'] },
    { id: 'une-serviette', targetText: 'une serviette', baseText: 'ein Handtuch', acceptedAnswers: ['une serviette', 'Une serviette'] },
    { id: 'sil-vous-plait', targetText: "s'il vous plaît", baseText: 'bitte', acceptedAnswers: ["s'il vous plaît", "S'il vous plaît", "s'il vous plait", "S'il vous plait", 's’il vous plaît', 'S’il vous plaît', 's’il vous plait', 'S’il vous plait', 'sil vous plait'] },
    { id: 'chambre', targetText: 'chambre', baseText: 'Zimmer', acceptedAnswers: ['chambre', 'Chambre'] },
  ],
  build: {
    targetText: "Une serviette, s'il vous plaît.",
    chips: ['Une serviette,', "s'il vous plaît.", 'la clé', 'ce train'],
  },
  typeRecall: {
    before: 'Une ',
    answer: 'serviette',
    after: ", s'il vous plaît.",
    acceptedAnswers: ['serviette', 'Serviette'],
    fallbackChoices: ['serviette', 'toilettes', 'chambre', 'clé'],
  },
  speakTarget: {
    baseCue: 'Ein Handtuch, bitte.',
    targetPhrase: "Une serviette, s'il vous plaît.",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['serviette', 'plaît'],
    optionalTokens: ['une', 'sil', 's', 'il', 'vous', 'plait'],
  },
  sceneCaption: 'Im Zimmer oder an der Rezeption bittest du kurz um ein Handtuch.',
  trophyWord: {
    word: 'serviette',
    meaning: 'Handtuch',
    example: "Une serviette, s'il vous plaît.",
    whyThisWord: 'Serviette heißt im Hotel Handtuch, kann in anderem Kontext aber auch Serviette bedeuten. Der Zimmerkontext klärt die Bedeutung.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotelzimmer oder Rezeption, Bitte um ein Handtuch.' },
  songSeed: { genre: 'soft room acoustic', mood: 'asking for a towel' },
  visualNotes: 'Gefaltetes Handtuch, Hotelzimmer, kurze Bitte.',
}

const brightFrenchP8Lesson008: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: 'Je vais dormir.',
    baseText: 'Ich gehe schlafen.',
  },
  meaning: 'Eine einfache neutrale Aussage am Ende des Tages.',
  chunks: [
    { id: 'je-vais', targetText: 'Je vais', baseText: 'Ich werde / gehe' },
    { id: 'dormir', targetText: 'dormir.', baseText: 'schlafen.' },
  ],
  lessonItems: [
    { id: 'dormir', targetText: 'dormir', baseText: 'schlafen', acceptedAnswers: ['dormir', 'Dormir'] },
    { id: 'je-vais', targetText: 'je vais', baseText: 'ich werde / gehe', acceptedAnswers: ['je vais', 'Je vais'] },
    { id: 'vais-dormir', targetText: 'vais dormir', baseText: 'gehe schlafen', acceptedAnswers: ['vais dormir', 'Vais dormir'] },
    { id: 'bonne-nuit', targetText: 'bonne nuit', baseText: 'gute Nacht', acceptedAnswers: ['bonne nuit', 'Bonne nuit'] },
  ],
  build: {
    targetText: 'Je vais dormir.',
    chips: ['Je vais', 'dormir.', 'à la gare', 's’il vous plaît'],
  },
  typeRecall: {
    before: 'Je vais ',
    answer: 'dormir',
    ...
    fallbackChoices: ['dormir', 'partir', 'appeler', 'écrire'],
  },
  speakTarget: {
    baseCue: 'Ich gehe schlafen.',
    targetPhrase: 'Je vais dormir.',
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['vais', 'dormir'],
    optionalTokens: ['je'],
  },
  sceneCaption: 'Im Hotelzimmer oder mit einer Begleitperson sagst du, dass du schlafen gehst.',
  trophyWord: {
    word: 'dormir',
    meaning: 'schlafen',
    example: 'Je vais dormir.',
    whyThisWord: 'Dormir ist das Grundverb für schlafen. Je vais + Infinitiv ist eine einfache A1-nahe Zukunftsform.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotelzimmer am Abend, ruhiger Tagesabschluss.' },
  songSeed: { genre: 'quiet evening acoustic', mood: 'going to sleep' },
  visualNotes: 'Hotelzimmer, Nachttischlampe, ruhige Abendstimmung.',
}

const brightFrenchP8Lesson009: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "À quelle heure est le petit-déjeuner ?",
    baseText: 'Um wie viel Uhr ist das Frühstück?',
  },
  meaning: 'Eine höfliche Hotel-Frage nach der Frühstückszeit.',
  chunks: [
    { id: 'a-quelle-heure-est', targetText: 'À quelle heure est', baseText: 'Um wie viel Uhr ist' },
    { id: 'le-petit-dejeuner', targetText: 'le petit-déjeuner ?', baseText: 'das Frühstück?' },
  ],
  lessonItems: [
    { id: 'petit-dejeuner', targetText: 'petit-déjeuner', baseText: 'Frühstück', acceptedAnswers: ['petit-déjeuner', 'petit dejeuner', 'Petit-déjeuner', 'Petit dejeuner'] },
    { id: 'le-petit-dejeuner', targetText: 'le petit-déjeuner', baseText: 'das Frühstück', acceptedAnswers: ['le petit-déjeuner', 'le petit dejeuner', 'Le petit-déjeuner', 'Le petit dejeuner'] },
    { id: 'a-quelle-heure', targetText: 'à quelle heure', baseText: 'um wie viel Uhr', acceptedAnswers: ['à quelle heure', 'a quelle heure', 'À quelle heure', 'A quelle heure'] },
    { id: 'est', targetText: 'est', baseText: 'ist', acceptedAnswers: ['est', 'Est'] },
  ],
  build: {
    targetText: "À quelle heure est le petit-déjeuner ?",
    chips: ['À quelle heure est', 'le petit-déjeuner ?', 'la clé', 'combien de temps'],
  },
  typeRecall: {
    before: 'À quelle heure est le ',
    answer: 'petit-déjeuner',
    after: ' ?',
    acceptedAnswers: ['petit-déjeuner', 'petit dejeuner', 'Petit-déjeuner', 'Petit dejeuner'],
    fallbackChoices: ['petit-déjeuner', 'check-out', 'Wi-Fi', 'médicament'],
  },
  speakTarget: {
    baseCue: 'Um wie viel Uhr ist das Frühstück?',
    targetPhrase: "À quelle heure est le petit-déjeuner ?",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['quelle', 'heure', 'petit', 'déjeuner'],
    optionalTokens: ['à', 'a', 'est', 'le', 'dejeuner'],
  },
  sceneCaption: 'An der Rezeption fragst du nach der Frühstückszeit.',
  trophyWord: {
    word: 'petit-déjeuner',
    meaning: 'Frühstück',
    example: "À quelle heure est le petit-déjeuner ?",
    whyThisWord: 'Petit-déjeuner ist Frühstück. Der Bindestrich gehört zur Standardschreibung; die Übung toleriert die Variante ohne Akzent/Bindestrich.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotellobby oder Frühstücksraum, Frage nach der Zeit.' },
  songSeed: { genre: 'morning hotel acoustic', mood: 'asking breakfast time' },
  visualNotes: 'Frühstücksraum-Schild, Uhr, Rezeption.',
}

const brightFrenchP8Lesson010: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: {
    targetText: "Je pars aujourd'hui.",
    baseText: 'Ich reise heute ab.',
  },
  meaning: 'Eine einfache Check-out-Eröffnung an der Rezeption ohne Rechnungsdiskussion.',
  chunks: [
    { id: 'je-pars', targetText: 'Je pars', baseText: 'Ich reise ab' },
    { id: 'aujourdhui', targetText: "aujourd'hui.", baseText: 'heute.' },
  ],
  lessonItems: [
    { id: 'pars', targetText: 'pars', baseText: 'reise ab / gehe weg', acceptedAnswers: ['pars', 'Pars'] },
    { id: 'je-pars', targetText: 'je pars', baseText: 'ich reise ab', acceptedAnswers: ['je pars', 'Je pars'] },
    { id: 'aujourdhui', targetText: "aujourd'hui", baseText: 'heute', acceptedAnswers: ["aujourd'hui", "Aujourd'hui", 'aujourd’hui', 'Aujourd’hui', 'aujourdhui', 'Aujourdhui'] },
    { id: 'aujourdhui-phrase', targetText: "je pars aujourd'hui", baseText: 'ich reise heute ab', acceptedAnswers: ["je pars aujourd'hui", "Je pars aujourd'hui", 'je pars aujourd’hui', 'Je pars aujourd’hui', 'je pars aujourdhui', 'Je pars aujourdhui'] },
  ],
  build: {
    targetText: "Je pars aujourd'hui.",
    chips: ['Je pars', "aujourd'hui.", 'une serviette', 'à quel étage'],
  },
  typeRecall: {
    before: 'Je ',
    answer: 'pars',
    after: " aujourd'hui.",
    acceptedAnswers: ['pars', 'Pars'],
    fallbackChoices: ['pars', 'part', 'vais', 'viens'],
  },
  speakTarget: {
    baseCue: 'Ich reise heute ab.',
    targetPhrase: "Je pars aujourd'hui.",
    language: 'fr-FR',
    passingThreshold: 0.8,
    requiredTokens: ['pars', 'aujourd', 'hui'],
    optionalTokens: ['je', 'aujourdhui'],
  },
  sceneCaption: 'Beim Check-out eröffnest du sachlich, dass du heute abreist.',
  trophyWord: {
    word: 'pars',
    meaning: 'reise ab / gehe weg',
    example: "Je pars aujourd'hui.",
    whyThisWord: 'Pars ist die je-Form von partir. Im Hotelkontext signalisiert der Satz den Check-out, ohne Rechnungs- oder Streitvokabular.',
  },
  placeholderMedia: { type: 'video', caption: 'Hotelrezeption am Abreisetag, sachlicher Check-out-Beginn.' },
  songSeed: { genre: 'departure acoustic', mood: 'checking out' },
  visualNotes: 'Koffer an der Rezeption, Abreise, klare kurze Aussage.',
}

const brightFrenchP9Lesson001: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "Salut, moi, c'est Marie.", baseText: 'Hi, ich bin Marie.' },
  meaning: 'Eine lockere erste Vorstellung in einem sozialen Moment.',
  chunks: [
    { id: 'salut', targetText: 'Salut,', baseText: 'Hi,' },
    { id: 'moi-cest-marie', targetText: "moi, c'est Marie.", baseText: 'ich bin Marie.' },
  ],
  lessonItems: [
    { id: 'salut', targetText: 'salut', baseText: 'hi / hallo', acceptedAnswers: ['salut', 'Salut'] },
    { id: 'moi', targetText: 'moi', baseText: 'ich / mir', acceptedAnswers: ['moi', 'Moi'] },
    { id: 'cest', targetText: "c'est", baseText: 'das ist / ich bin', acceptedAnswers: ["c'est", "C'est", 'c’est', 'C’est', 'c est', 'C est'] },
  ...
  placeholderMedia: { type: 'video', caption: 'Lockeres erstes Treffen, kurze Vorstellung.' },
  songSeed: { genre: 'bright social acoustic', mood: 'first hello' },
  visualNotes: 'Kleines Treffen, freundliche lockere Vorstellung.',
}

const brightFrenchP9Lesson002: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "Tu as du temps aujourd'hui ?", baseText: 'Hast du heute Zeit?' },
  meaning: 'Eine lockere Frage nach Zeit heute, nicht speziell am Abend.',
  chunks: [
    { id: 'tu-as-du-temps', targetText: 'Tu as du temps', baseText: 'Du hast Zeit' },
    { id: 'aujourdhui', targetText: "aujourd'hui ?", baseText: 'heute?' },
  ],
  lessonItems: [
    { id: 'aujourdhui', targetText: "aujourd'hui", baseText: 'heute', acceptedAnswers: ["aujourd'hui", "Aujourd'hui", 'aujourd’hui', 'Aujourd’hui', 'aujourdhui', 'Aujourdhui'] },
    { id: 'du-temps', targetText: 'du temps', baseText: 'Zeit', acceptedAnswers: ['du temps', 'Du temps'] },
    { id: 'tu-as', targetText: 'tu as', baseText: 'du hast', acceptedAnswers: ['tu as', 'Tu as'] },
    { id: 'temps', targetText: 'temps', baseText: 'Zeit', acceptedAnswers: ['temps', 'Temps'] },
  ],
  build: { targetText: "Tu as du temps aujourd'hui ?", chips: ['Tu as du temps', "aujourd'hui ?", 'ce soir', 'à la gare'] },
  typeRecall: { before: 'Tu as du temps ', answer: "aujourd'hui", after: ' ?', acceptedAnswers: ["aujourd'hui", 'aujourd’hui', 'aujourdhui', "Aujourd'hui", 'Aujourd’hui', 'Aujourdhui'], fallbackChoices: ["aujourd'hui", 'demain', 'hier', 'maintenant'] },
  speakTarget: { baseCue: 'Hast du heute Zeit?', targetPhrase: "Tu as du temps aujourd'hui ?", language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['temps', 'aujourd'], optionalTokens: ['tu', 'as', 'du', 'hui', 'aujourdhui'] },
  sceneCaption: 'Du fragst eine bekannte Person locker, ob sie heute irgendwann Zeit hat.',
  trophyWord: { word: "aujourd'hui", meaning: 'heute', example: "Tu as du temps aujourd'hui ?", whyThisWord: 'Aujourd’hui bedeutet heute. Die Frage bleibt tagsüber allgemein und ist nicht wie P5 auf den Abend beschränkt.' },
  placeholderMedia: { type: 'video', caption: 'Lockere Tagesplanung per Gespräch oder Nachricht.' },
  songSeed: { genre: 'casual planning acoustic', mood: 'checking time today' },
  visualNotes: 'Smartphone, Tageslicht, lockere Frage.',
}

const brightFrenchP9Lesson003: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'On se voit plus tard ?', baseText: 'Sehen wir uns später?' },
  meaning: 'Ein lockerer Vorschlag für ein Treffen später am selben Tag.',
  chunks: [
    { id: 'on-se-voit', targetText: 'On se voit', baseText: 'Wir sehen uns' },
    { id: 'plus-tard', targetText: 'plus tard ?', baseText: 'später?' },
  ],
  lessonItems: [
    { id: 'plus-tard', targetText: 'plus tard', baseText: 'später', acceptedAnswers: ['plus tard', 'Plus tard'] },
    { id: 'on-se-voit', targetText: 'on se voit', baseText: 'wir sehen uns', acceptedAnswers: ['on se voit', 'On se voit'] },
    { id: 'voit', targetText: 'voit', baseText: 'sieht', acceptedAnswers: ['voit', 'Voit'] },
    { id: 'tard', targetText: 'tard', baseText: 'spät', acceptedAnswers: ['tard', 'Tard'] },
  ],
  build: { targetText: 'On se voit plus tard ?', chips: ['On se voit', 'plus tard ?', 'à demain', 'le Wi-Fi'] },
  typeRecall: { before: 'On se voit ', answer: 'plus tard', after: ' ?', acceptedAnswers: ['plus tard', 'Plus tard'], fallbackChoices: ['plus tard', 'tout de suite', 'à midi', 'ce matin'] },
  speakTarget: { baseCue: 'Sehen wir uns später?', targetPhrase: 'On se voit plus tard ?', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['voit', 'plus', 'tard'], optionalTokens: ['on', 'se'] },
  sceneCaption: 'Im Lauf des Tages schlägst du ein späteres Treffen vor.',
  trophyWord: { word: 'plus tard', meaning: 'später', example: 'On se voit plus tard ?', whyThisWord: 'Plus tard ist die einfache A1-Zeitangabe für später. Die Phrase meint später am selben Tag.' },
  placeholderMedia: { type: 'video', caption: 'Lockeres Gespräch am Nachmittag, Vorschlag für später.' },
  songSeed: { genre: 'afternoon acoustic', mood: 'meeting later' },
  visualNotes: 'Nachmittag, kurzer Planungsdialog.',
}

const brightFrenchP9Lesson004: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "Ça te va à quelle heure ?", baseText: 'Um wie viel Uhr passt es dir?' },
  meaning: 'Eine lockere Frage, welche Uhrzeit der anderen Person passt.',
  chunks: [
    { id: 'ca-te-va', targetText: 'Ça te va', baseText: 'Es passt dir' },
    { id: 'a-quelle-heure', targetText: 'à quelle heure ?', baseText: 'um wie viel Uhr?' },
  ],
  lessonItems: [
    { id: 'quelle', targetText: 'quelle', baseText: 'welche', acceptedAnswers: ['quelle', 'Quelle'] },
    { id: 'quelle-heure', targetText: 'quelle heure', baseText: 'welche Uhrzeit', acceptedAnswers: ['quelle heure', 'Quelle heure'] },
    { id: 'ca-te-va', targetText: 'ça te va', baseText: 'es passt dir', acceptedAnswers: ['ça te va', 'ca te va', 'Ça te va', 'Ca te va'] },
    { id: 'te', targetText: 'te', baseText: 'dir / dich', acceptedAnswers: ['te', 'Te'] },
  ],
  build: { targetText: "Ça te va à quelle heure ?", chips: ['Ça te va', 'à quelle heure ?', 's’il vous plaît', 'une clé'] },
  typeRecall: { before: 'Ça te va à ', answer: 'quelle', after: ' heure ?', acceptedAnswers: ['quelle', 'Quelle'], fallbackChoices: ['quelle', 'quel', 'quand', 'combien'] },
  speakTarget: { baseCue: 'Um wie viel Uhr passt es dir?', targetPhrase: "Ça te va à quelle heure ?", language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['va', 'quelle', 'heure'], optionalTokens: ['ça', 'ca', 'te', 'à', 'a'] },
  sceneCaption: 'Du lässt die andere Person die passende Uhrzeit wählen.',
  trophyWord: { word: 'quelle', meaning: 'welche', example: "Ça te va à quelle heure ?", whyThisWord: 'Quelle ist die feminine Form vor heure. Mit te bleibt die Frage bewusst im vertrauten tu-Register.' },
  placeholderMedia: { type: 'video', caption: 'Zwei Personen stimmen eine Uhrzeit ab.' },
  songSeed: { genre: 'planning acoustic', mood: 'choosing a time' },
  visualNotes: 'Kalender oder Uhr, lockere Abstimmung.',
}

const brightFrenchP9Lesson005: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Rendez-vous ici ?', baseText: 'Treffen wir uns hier?' },
  meaning: 'Ein knapper Vorschlag, den aktuellen Ort als Treffpunkt zu nehmen.',
  chunks: [
    { id: 'rendez-vous', targetText: 'Rendez-vous', baseText: 'Treffen' },
    { id: 'ici', targetText: 'ici ?', baseText: 'hier?' },
  ],
  lessonItems: [
    { id: 'rendez-vous', targetText: 'rendez-vous', baseText: 'Treffen / Termin', acceptedAnswers: ['rendez-vous', 'Rendez-vous', 'rendez vous', 'Rendez vous'] },
    { id: 'ici', targetText: 'ici', baseText: 'hier', acceptedAnswers: ['ici', 'Ici'] },
    { id: 'lieu', targetText: 'lieu', baseText: 'Ort', acceptedAnswers: ['lieu', 'Lieu'] },
  ...
  placeholderMedia: { type: 'video', caption: 'Vor einem Café oder Eingang wird der Treffpunkt bestätigt.' },
  songSeed: { genre: 'street acoustic', mood: 'meeting here' },
  visualNotes: 'Eingang, Treffpunkt, kurze Bestätigung.',
}

const brightFrenchP9Lesson006: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "J'attends dehors.", baseText: 'Ich warte draußen.' },
  meaning: 'Eine kurze Nachricht oder Aussage, dass du draußen wartest.',
  chunks: [
    { id: 'jattends', targetText: "J'attends", baseText: 'Ich warte' },
    { id: 'dehors', targetText: 'dehors.', baseText: 'draußen.' },
  ],
  lessonItems: [
    { id: 'dehors', targetText: 'dehors', baseText: 'draußen', acceptedAnswers: ['dehors', 'Dehors'] },
    { id: 'jattends', targetText: "j'attends", baseText: 'ich warte', acceptedAnswers: ["j'attends", "J'attends", 'j’attends', 'J’attends', 'j attends', 'J attends'] },
    { id: 'attends', targetText: 'attends', baseText: 'warte', acceptedAnswers: ['attends', 'Attends'] },
  ...
  placeholderMedia: { type: 'video', caption: 'Vor einer Tür oder auf dem Gehweg, kurze Nachricht.' },
  songSeed: { genre: 'light street acoustic', mood: 'waiting outside' },
  visualNotes: 'Tür, Gehweg, wartende Person.',
}

const brightFrenchP9Lesson007: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Désolé, je vais arriver tard.', baseText: 'Tut mir leid, ich werde spät ankommen.' },
  meaning: 'Eine lockere Verspätungsnachricht ohne das bereits gelernte en retard als Trophy.',
  chunks: [
    { id: 'desole', targetText: 'Désolé,', baseText: 'Tut mir leid,' },
    { id: 'je-vais-arriver-tard', targetText: 'je vais arriver tard.', baseText: 'ich werde spät ankommen.' },
  ],
  lessonItems: [
    { id: 'desole', targetText: 'désolé', baseText: 'tut mir leid', acceptedAnswers: ['désolé', 'desole', 'Désolé', 'Desole', 'désolée', 'desolee', 'Désolée', 'Desolee'] },
    { id: 'arriver', targetText: 'arriver', baseText: 'ankommen', acceptedAnswers: ['arriver', 'Arriver'] },
    { id: 'tard', targetText: 'tard', baseText: 'spät', acceptedAnswers: ['tard', 'Tard'] },
    { id: 'je-vais', targetText: 'je vais', baseText: 'ich werde', acceptedAnswers: ['je vais', 'Je vais'] },
  ],
  build: { targetText: 'Désolé, je vais arriver tard.', chips: ['Désolé,', 'je vais arriver tard.', 'bonne soirée', 'une serviette'] },
  typeRecall: { before: '', answer: 'Désolé', after: ', je vais arriver tard.', acceptedAnswers: ['Désolé', 'Desole', 'désolé', 'desole', 'Désolée', 'Desolee', 'désolée', 'desolee'], fallbackChoices: ['Désolé', 'Enchanté', 'Bonjour', 'Parfait'] },
  speakTarget: { baseCue: 'Tut mir leid, ich werde spät ankommen.', targetPhrase: 'Désolé, je vais arriver tard.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['désolé', 'arriver', 'tard'], optionalTokens: ['desole', 'désolée', 'je', 'vais'] },
  sceneCaption: 'Unterwegs schickst du eine kurze Nachricht, dass du spät kommst.',
  trophyWord: { word: 'désolé', meaning: 'tut mir leid', example: 'Désolé, je vais arriver tard.', whyThisWord: 'Désolé ist maskulin; eine Sprecherin schreibt désolée. Beide Formen werden akzeptiert, klingen aber gleich.' },
  placeholderMedia: { type: 'video', caption: 'Nachricht unterwegs, kurze Verspätungsinfo.' },
  songSeed: { genre: 'moving acoustic', mood: 'running late' },
  visualNotes: 'Smartphone, Straße, kurze Entschuldigung.',
}

const brightFrenchP9Lesson008: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'On peut changer le plan ?', baseText: 'Können wir den Plan ändern?' },
  meaning: 'Eine einfache, lockere Bitte, einen bestehenden Plan zu ändern.',
  chunks: [
    { id: 'on-peut-changer', targetText: 'On peut changer', baseText: 'Wir können ändern' },
    { id: 'le-plan', targetText: 'le plan ?', baseText: 'den Plan?' },
  ],
  lessonItems: [
    { id: 'changer', targetText: 'changer', baseText: 'ändern', acceptedAnswers: ['changer', 'Changer'] },
    { id: 'on-peut', targetText: 'on peut', baseText: 'wir können', acceptedAnswers: ['on peut', 'On peut'] },
    { id: 'le-plan', targetText: 'le plan', baseText: 'der Plan', acceptedAnswers: ['le plan', 'Le plan'] },
    { id: 'peut', targetText: 'peut', baseText: 'kann', acceptedAnswers: ['peut', 'Peut'] },
  ],
  build: { targetText: 'On peut changer le plan ?', chips: ['On peut changer', 'le plan ?', 'je voudrais', 'les toilettes'] },
  typeRecall: { before: 'On peut ', answer: 'changer', after: ' le plan ?', acceptedAnswers: ['changer', 'Changer'], fallbackChoices: ['changer', 'écrire', 'appeler', 'dormir'] },
  speakTarget: { baseCue: 'Können wir den Plan ändern?', targetPhrase: 'On peut changer le plan ?', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['peut', 'changer', 'plan'], optionalTokens: ['on', 'le'] },
  sceneCaption: 'In einem lockeren Gespräch schlägst du vor, den Plan einfach zu ändern.',
  trophyWord: { word: 'changer', meaning: 'ändern', example: 'On peut changer le plan ?', whyThisWord: 'Changer ist ändern. On peut ist hier das vertraute wir können, nicht formelles vous.' },
  placeholderMedia: { type: 'video', caption: 'Zwei Personen ändern einen einfachen Plan.' },
  songSeed: { genre: 'planning acoustic', mood: 'changing plans' },
  visualNotes: 'Kalender, Smartphone, ruhige Planänderung.',
}

const brightFrenchP9Lesson009: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'À demain midi.', baseText: 'Bis morgen Mittag.' },
  meaning: 'Ein sozialer Abschluss mit einer konkreten Zeit morgen.',
  chunks: [
    { id: 'a-demain', targetText: 'À demain', baseText: 'Bis morgen' },
    { id: 'midi', targetText: 'midi.', baseText: 'Mittag.' },
  ],
  lessonItems: [
    { id: 'midi', targetText: 'midi', baseText: 'Mittag', acceptedAnswers: ['midi', 'Midi'] },
    { id: 'a-demain-midi', targetText: 'à demain midi', baseText: 'bis morgen Mittag', acceptedAnswers: ['à demain midi', 'a demain midi', 'À demain midi', 'A demain midi'] },
    { id: 'demain', targetText: 'demain', baseText: 'morgen', acceptedAnswers: ['demain', 'Demain'] },
    { id: 'a-demain', targetText: 'à demain', baseText: 'bis morgen', acceptedAnswers: ['à demain', 'a demain', 'À demain', 'A demain'] },
  ],
  build: { targetText: 'À demain midi.', chips: ['À demain', 'midi.', 'plus tard', 'la clé'] },
  typeRecall: { before: 'À demain ', answer: 'midi', after: '.', acceptedAnswers: ['midi', 'Midi'], fallbackChoices: ['midi', 'soir', 'matin', 'temps'] },
  speakTarget: { baseCue: 'Bis morgen Mittag.', targetPhrase: 'À demain midi.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['demain', 'midi'], optionalTokens: ['à', 'a'] },
  sceneCaption: 'Du schließt die Planung mit einer konkreten Verabredung für morgen Mittag.',
  trophyWord: { word: 'midi', meaning: 'Mittag', example: 'À demain midi.', whyThisWord: 'Midi ist Mittag. Die konkrete Zeit unterscheidet diese Planung von einem allgemeinen à demain.' },
  placeholderMedia: { type: 'video', caption: 'Ende eines lockeren Planungsgesprächs.' },
  songSeed: { genre: 'warm social acoustic', mood: 'see you tomorrow noon' },
  visualNotes: 'Kalender, Morgenplan, freundlicher Abschluss.',
}

const brightFrenchP9Lesson010: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Bonne soirée.', baseText: 'Schönen Abend.' },
  meaning: 'Eine höfliche Abendformel am Ende eines sozialen oder Service-Kontakts.',
  chunks: [
    { id: 'bonne', targetText: 'Bonne', baseText: 'schöne' },
    { id: 'soiree', targetText: 'soirée.', baseText: 'Abend.' },
  ],
  lessonItems: [
    { id: 'soiree', targetText: 'soirée', baseText: 'Abend', acceptedAnswers: ['soirée', 'soiree', 'Soirée', 'Soiree'] },
    { id: 'bonne-soiree', targetText: 'bonne soirée', baseText: 'schönen Abend', acceptedAnswers: ['bonne soirée', 'bonne soiree', 'Bonne soirée', 'Bonne soiree'] },
    { id: 'bonne', targetText: 'bonne', baseText: 'gute / schöne', acceptedAnswers: ['bonne', 'Bonne'] },
    { id: 'soir', targetText: 'soir', baseText: 'Abend', acceptedAnswers: ['soir', 'Soir'] },
  ],
  ...
  placeholderMedia: { type: 'video', caption: 'Abendlicher Abschied nach einem Treffen oder Servicekontakt.' },
  songSeed: { genre: 'evening acoustic', mood: 'polite evening goodbye' },
  visualNotes: 'Abendlicht, freundlicher Abschied.',
}

const brightFrenchP10Lesson001: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "C'était une bonne journée.", baseText: 'Es war ein guter Tag.' },
  meaning: 'Ein kurzer positiver Tagesabschluss mit c’était.',
  chunks: [
    { id: 'cetait', targetText: "C'était", baseText: 'es war' },
    { id: 'une-bonne-journee', targetText: 'une bonne journée.', baseText: 'ein guter Tag.' },
  ],
  lessonItems: [
    { id: 'cetait', targetText: "c'était", baseText: 'es war', acceptedAnswers: ["c'était", "C'était", 'c’etait', 'C’etait', 'cetait', 'Cetait', 'c etait', 'C etait'] },
    { id: 'journee', targetText: 'journée', baseText: 'Tag', acceptedAnswers: ['journée', 'journee', 'Journée', 'Journee'] },
    { id: 'bonne', targetText: 'bonne', baseText: 'gute', acceptedAnswers: ['bonne', 'Bonne'] },
  ...
  placeholderMedia: { type: 'video', caption: 'Ruhiger Tagesabschluss mit positivem Satz.' },
  songSeed: { genre: 'warm acoustic', mood: 'good day wrap-up' },
  visualNotes: 'Abendliches Notizbuch, kurzer positiver Rückblick.',
}

const brightFrenchP10Lesson002: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "C'était bien ici.", baseText: 'Es war schön hier.' },
  meaning: 'Ein einfacher positiver Kommentar über einen Ort beim Weggehen.',
  chunks: [
    { id: 'cetait', targetText: "C'était", baseText: 'es war' },
    { id: 'bien-ici', targetText: 'bien ici.', baseText: 'schön hier.' },
  ],
  lessonItems: [
    { id: 'bien', targetText: 'bien', baseText: 'gut / schön', acceptedAnswers: ['bien', 'Bien'] },
    { id: 'ici', targetText: 'ici', baseText: 'hier', acceptedAnswers: ['ici', 'Ici'] },
    { id: 'cetait-bien', targetText: "c'était bien", baseText: 'es war schön', acceptedAnswers: ["c'était bien", "C'était bien", 'c’etait bien', 'C’etait bien', 'cetait bien', 'Cetait bien'] },
    { id: 'bien-ici', targetText: 'bien ici', baseText: 'schön hier', acceptedAnswers: ['bien ici', 'Bien ici'] },
  ],
  build: { targetText: "C'était bien ici.", chips: ["C'était", 'bien ici.', 'à la prochaine', 'je dois'] },
  typeRecall: { before: "C'était ", answer: 'bien', after: ' ici.', acceptedAnswers: ['bien', 'Bien'], fallbackChoices: ['bien', 'loin', 'tard', 'dehors'] },
  speakTarget: { baseCue: 'Es war schön hier.', targetPhrase: "C'était bien ici.", language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['cétait', 'bien', 'ici'], optionalTokens: ['cetait'] },
  sceneCaption: 'Beim Verlassen eines Cafés oder Museums sagst du kurz etwas Positives.',
  trophyWord: { word: 'bien', meaning: 'gut / schön', example: "C'était bien ici.", whyThisWord: 'Bien bewertet die Erfahrung einfach und natürlich. Es bleibt neutraler als ein großes Kompliment.' },
  placeholderMedia: { type: 'video', caption: 'Du gehst aus einem schönen Ort und kommentierst kurz positiv.' },
  songSeed: { genre: 'light pop', mood: 'leaving a nice place' },
  visualNotes: 'Tür eines Cafés oder Museums, kurzer positiver Abschied.',
}

const brightFrenchP10Lesson003: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Merci pour votre aide.', baseText: 'Danke für Ihre Hilfe.' },
  meaning: 'Ein höflicher Dank am Ende einer Service- oder Hilfe-Situation.',
  chunks: [
    { id: 'merci-pour', targetText: 'Merci pour', baseText: 'danke für' },
    { id: 'votre-aide', targetText: 'votre aide.', baseText: 'Ihre Hilfe.' },
  ],
  lessonItems: [
    { id: 'votre', targetText: 'votre', baseText: 'Ihr / euer', acceptedAnswers: ['votre', 'Votre'] },
    { id: 'aide', targetText: 'aide', baseText: 'Hilfe', acceptedAnswers: ['aide', 'Aide'] },
    { id: 'merci-pour', targetText: 'merci pour', baseText: 'danke für', acceptedAnswers: ['merci pour', 'Merci pour'] },
    { id: 'votre-aide', targetText: 'votre aide', baseText: 'Ihre Hilfe', acceptedAnswers: ['votre aide', 'Votre aide'] },
  ],
  build: { targetText: 'Merci pour votre aide.', chips: ['Merci pour', 'votre aide.', 'ton aide', 'bonne journée'] },
  typeRecall: { before: 'Merci pour ', answer: 'votre', after: ' aide.', acceptedAnswers: ['votre', 'Votre'], fallbackChoices: ['votre', 'ton', 'ta', 'son'] },
  speakTarget: { baseCue: 'Danke für Ihre Hilfe.', targetPhrase: 'Merci pour votre aide.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['merci', 'votre', 'aide'], optionalTokens: ['pour'] },
  sceneCaption: 'Nach einer Hilfe oder Auskunft bedankst du dich höflich.',
  trophyWord: { word: 'votre', meaning: 'Ihr / euer', example: 'Merci pour votre aide.', whyThisWord: 'Votre passt zu vous: höflich für eine fremde Person oder plural für mehrere Personen. In Service-Kontexten ist es sicherer als ton.' },
  placeholderMedia: { type: 'video', caption: 'Höfliches Danke nach Hilfe.' },
  songSeed: { genre: 'clean piano pop', mood: 'polite thanks' },
  visualNotes: 'Service-Schalter oder soziale Hilfe, klarer Dank.',
}

const brightFrenchP10Lesson004: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: "J'ai beaucoup appris.", baseText: 'Ich habe viel gelernt.' },
  meaning: 'Ein einfacher Rückblick auf das Gelernte.',
  chunks: [
    { id: 'jai', targetText: "J'ai", baseText: 'ich habe' },
    { id: 'beaucoup-appris', targetText: 'beaucoup appris.', baseText: 'viel gelernt.' },
  ],
  lessonItems: [
    { id: 'appris', targetText: 'appris', baseText: 'gelernt', acceptedAnswers: ['appris', 'Appris'] },
    { id: 'beaucoup', targetText: 'beaucoup', baseText: 'viel', acceptedAnswers: ['beaucoup', 'Beaucoup', 'beacoup'] },
    { id: 'jai', targetText: "j'ai", baseText: 'ich habe', acceptedAnswers: ["j'ai", "J'ai", 'j’ai', 'J’ai', 'jai', 'Jai', 'je ai', 'Je ai'] },
    { id: 'beaucoup-appris', targetText: 'beaucoup appris', baseText: 'viel gelernt', acceptedAnswers: ['beaucoup appris', 'Beaucoup appris'] },
  ],
  build: { targetText: "J'ai beaucoup appris.", chips: ["J'ai", 'beaucoup appris.', 'je suis', 'la prochaine'] },
  typeRecall: { before: "J'ai beaucoup ", answer: 'appris', after: '.', acceptedAnswers: ['appris', 'Appris'], fallbackChoices: ['appris', 'arrivé', 'ouvert', 'fatigué'] },
  speakTarget: { baseCue: 'Ich habe viel gelernt.', targetPhrase: "J'ai beaucoup appris.", language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['jai', 'beaucoup', 'appris'], optionalTokens: ['j’ai'] },
  sceneCaption: 'Am Ende eines Kurses oder Tages sagst du, dass du viel gelernt hast.',
  trophyWord: { word: 'appris', meaning: 'gelernt', example: "J'ai beaucoup appris.", whyThisWord: 'Appris ist die Form in j’ai appris. J’ai zeigt die Pflichtelision von je vor ai.' },
  placeholderMedia: { type: 'video', caption: 'Kurzer Lernrückblick nach einem Tag.' },
  songSeed: { genre: 'soft synth pop', mood: 'learning reflection' },
  visualNotes: 'Notizen, kurze Reflexion, heller Abschluss.',
}

const brightFrenchP10Lesson005: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Je suis fatigué maintenant.', baseText: 'Ich bin jetzt müde.' },
  meaning: 'Eine einfache, undramatische Aussage am Ende des Tages.',
  chunks: [
    { id: 'je-suis', targetText: 'Je suis', baseText: 'ich bin' },
    { id: 'fatigue-maintenant', targetText: 'fatigué maintenant.', baseText: 'jetzt müde.' },
  ],
  lessonItems: [
    { id: 'fatigue', targetText: 'fatigué', baseText: 'müde', acceptedAnswers: ['fatigué', 'fatigue', 'Fatigué', 'Fatigue', 'fatiguée', 'fatiguee', 'Fatiguée', 'Fatiguee'] },
    { id: 'maintenant', targetText: 'maintenant', baseText: 'jetzt', acceptedAnswers: ['maintenant', 'Maintenant'] },
    { id: 'je-suis', targetText: 'je suis', baseText: 'ich bin', acceptedAnswers: ['je suis', 'Je suis'] },
  ...
  trophyWord: { word: 'fatigué', meaning: 'müde', example: 'Je suis fatigué maintenant.', whyThisWord: 'Fatigué ist maskulin; eine Sprecherin schreibt fatiguée. Die Aussprache ist gleich, die Schreibweise markiert das Geschlecht.' },
  placeholderMedia: { type: 'video', caption: 'Ruhige Müdigkeit am Ende des Tages.' },
  songSeed: { genre: 'slow acoustic', mood: 'tired but calm' },
  visualNotes: 'Abend, Tasche, ruhiger Heimweg.',
}

const brightFrenchP10Lesson006: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Je dois y aller.', baseText: 'Ich muss gehen.' },
  meaning: 'Eine neutrale Form, um das Weggehen anzukündigen.',
  chunks: [
    { id: 'je-dois', targetText: 'Je dois', baseText: 'ich muss' },
    { id: 'y-aller', targetText: 'y aller.', baseText: 'gehen.' },
  ],
  lessonItems: [
    { id: 'aller', targetText: 'aller', baseText: 'gehen', acceptedAnswers: ['aller', 'Aller'] },
    { id: 'dois', targetText: 'dois', baseText: 'muss', acceptedAnswers: ['dois', 'Dois'] },
    { id: 'y-aller', targetText: 'y aller', baseText: 'gehen / losgehen', acceptedAnswers: ['y aller', 'Y aller'] },
    { id: 'je-dois', targetText: 'je dois', baseText: 'ich muss', acceptedAnswers: ['je dois', 'Je dois'] },
  ],
  build: { targetText: 'Je dois y aller.', chips: ['Je dois', 'y aller.', 'je voudrais', 'la nuit'] },
  typeRecall: { before: 'Je dois y ', answer: 'aller', after: '.', acceptedAnswers: ['aller', 'Aller'], fallbackChoices: ['aller', 'aider', 'changer', 'dormir'] },
  speakTarget: { baseCue: 'Ich muss gehen.', targetPhrase: 'Je dois y aller.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['dois', 'aller'], optionalTokens: ['je', 'y'] },
  sceneCaption: 'Du kündigst ruhig an, dass du gehen musst.',
  trophyWord: { word: 'aller', meaning: 'gehen', example: 'Je dois y aller.', whyThisWord: 'Aller ist ein A1-Grundverb. In y aller bedeutet es idiomatisch losgehen oder gehen.' },
  placeholderMedia: { type: 'video', caption: 'Kurzer Aufbruch aus einem Gespräch.' },
  songSeed: { genre: 'gentle indie pop', mood: 'leaving now' },
  visualNotes: 'Tür, Jacke, kurzer Abschied.',
}

const brightFrenchP10Lesson007: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'À la prochaine.', baseText: 'Bis zum nächsten Mal.' },
  meaning: 'Ein offener Abschied ohne festen nächsten Termin.',
  chunks: [
    { id: 'a-la', targetText: 'À la', baseText: 'bis zur' },
    { id: 'prochaine', targetText: 'prochaine.', baseText: 'nächsten.' },
  ],
  lessonItems: [
    { id: 'prochaine', targetText: 'prochaine', baseText: 'nächste', acceptedAnswers: ['prochaine', 'Prochaine'] },
    { id: 'a-la-prochaine', targetText: 'à la prochaine', baseText: 'bis zum nächsten Mal', acceptedAnswers: ['à la prochaine', 'a la prochaine', 'À la prochaine', 'A la prochaine'] },
    { id: 'a-la', targetText: 'à la', baseText: 'bis zur', acceptedAnswers: ['à la', 'a la', 'À la', 'A la'] },
  ...
  placeholderMedia: { type: 'video', caption: 'Offener sozialer Abschied.' },
  songSeed: { genre: 'bright acoustic', mood: 'see you next time' },
  visualNotes: 'Freundlicher Abschied an der Tür.',
}

const brightFrenchP10Lesson008: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Demain, ça me va.', baseText: 'Morgen passt mir.' },
  meaning: 'Eine lockere Bestätigung für einen Vorschlag morgen.',
  chunks: [
    { id: 'demain', targetText: 'Demain,', baseText: 'morgen,' },
    { id: 'ca-me-va', targetText: 'ça me va.', baseText: 'das passt mir.' },
  ],
  lessonItems: [
    { id: 'va', targetText: 'va', baseText: 'passt / geht', acceptedAnswers: ['va', 'Va'] },
    { id: 'ca-me-va', targetText: 'ça me va', baseText: 'das passt mir', acceptedAnswers: ['ça me va', 'ca me va', 'Ça me va', 'Ca me va'] },
    { id: 'demain', targetText: 'demain', baseText: 'morgen', acceptedAnswers: ['demain', 'Demain'] },
    { id: 'me', targetText: 'me', baseText: 'mir / mich', acceptedAnswers: ['me', 'Me'] },
  ],
  build: { targetText: 'Demain, ça me va.', chips: ['Demain,', 'ça me va.', 'à la prochaine', 'je suis fatigué'] },
  typeRecall: { before: 'Demain, ça me ', answer: 'va', after: '.', acceptedAnswers: ['va', 'Va'], fallbackChoices: ['va', 'vais', 'viens', 'pars'] },
  speakTarget: { baseCue: 'Morgen passt mir.', targetPhrase: 'Demain, ça me va.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['demain', 'ça', 'va'], optionalTokens: ['ca', 'me'] },
  sceneCaption: 'Du bestätigst locker, dass ein Vorschlag für morgen passt.',
  trophyWord: { word: 'va', meaning: 'passt / geht', example: 'Demain, ça me va.', whyThisWord: 'Ça me va ist die natürliche A1-Form für das passt mir. Hier ist es vertraut und sozial, nicht formell.' },
  placeholderMedia: { type: 'video', caption: 'Kurze Bestätigung eines Plans für morgen.' },
  songSeed: { genre: 'light electronic', mood: 'plan confirmed' },
  visualNotes: 'Chat-Nachricht, einfacher Plan bestätigt.',
}

const brightFrenchP10Lesson009: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Bonne nuit.', baseText: 'Gute Nacht.' },
  meaning: 'Eine Abendformel direkt vor der Nacht oder dem Schlafengehen.',
  chunks: [
    { id: 'bonne', targetText: 'Bonne', baseText: 'gute' },
    { id: 'nuit', targetText: 'nuit.', baseText: 'Nacht.' },
  ],
  lessonItems: [
    { id: 'nuit', targetText: 'nuit', baseText: 'Nacht', acceptedAnswers: ['nuit', 'Nuit'] },
    { id: 'bonne-nuit', targetText: 'bonne nuit', baseText: 'gute Nacht', acceptedAnswers: ['bonne nuit', 'Bonne nuit'] },
    { id: 'bonne', targetText: 'bonne', baseText: 'gute', acceptedAnswers: ['bonne', 'Bonne'] },
    { id: 'soir', targetText: 'soir', baseText: 'Abend', acceptedAnswers: ['soir', 'Soir'] },
  ],
  build: { targetText: 'Bonne nuit.', chips: ['Bonne', 'nuit.', 'bonne soirée', 'merci pour'] },
  typeRecall: { before: 'Bonne ', answer: 'nuit', after: '.', acceptedAnswers: ['nuit', 'Nuit'], fallbackChoices: ['nuit', 'soirée', 'journée', 'midi'] },
  speakTarget: { baseCue: 'Gute Nacht.', targetPhrase: 'Bonne nuit.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['bonne', 'nuit'], optionalTokens: [] },
  sceneCaption: 'Am Ende des Abends verabschiedest du dich für die Nacht.',
  trophyWord: { word: 'nuit', meaning: 'Nacht', example: 'Bonne nuit.', whyThisWord: 'Bonne nuit sagt man vor der Nacht oder vor dem Schlafen. Bonne soirée ist früher am Abend beim Weggehen.' },
  placeholderMedia: { type: 'video', caption: 'Ruhiger Abschied vor der Nacht.' },
  songSeed: { genre: 'soft lullaby pop', mood: 'good night' },
  visualNotes: 'Nachtlicht, kurzer höflicher Abschluss.',
}

const brightFrenchP10Lesson010: GuidedLessonVibeVariant = {
  contentStatus: 'draft',
  corePhrase: { targetText: 'Au revoir pour le moment.', baseText: 'Auf Wiedersehen für den Moment.' },
  meaning: 'Ein kurzer höflicher Meta-Abschied am Ende des ganzen Pfads.',
  chunks: [
    { id: 'au-revoir', targetText: 'Au revoir', baseText: 'auf Wiedersehen' },
    { id: 'pour-le-moment', targetText: 'pour le moment.', baseText: 'für den Moment.' },
  ],
  lessonItems: [
    { id: 'moment', targetText: 'moment', baseText: 'Moment', acceptedAnswers: ['moment', 'Moment'] },
    { id: 'au-revoir', targetText: 'au revoir', baseText: 'auf Wiedersehen', acceptedAnswers: ['au revoir', 'Au revoir'] },
    { id: 'pour-le-moment', targetText: 'pour le moment', baseText: 'für den Moment', acceptedAnswers: ['pour le moment', 'Pour le moment'] },
    { id: 'pour', targetText: 'pour', baseText: 'für', acceptedAnswers: ['pour', 'Pour'] },
  ],
  build: { targetText: 'Au revoir pour le moment.', chips: ['Au revoir', 'pour le moment.', 'bonne nuit', 'à bientôt'] },
  typeRecall: { before: 'Au revoir pour le ', answer: 'moment', after: '.', acceptedAnswers: ['moment', 'Moment'], fallbackChoices: ['moment', 'matin', 'midi', 'soir'] },
  speakTarget: { baseCue: 'Auf Wiedersehen für den Moment.', targetPhrase: 'Au revoir pour le moment.', language: 'fr-FR', passingThreshold: 0.8, requiredTokens: ['revoir', 'moment'], optionalTokens: ['au', 'pour', 'le'] },
  sceneCaption: 'Zum Abschluss des ganzen Pfads verabschiedest du dich höflich und kurz.',
  trophyWord: { word: 'moment', meaning: 'Moment', example: 'Au revoir pour le moment.', whyThisWord: 'Moment ist transparent, aber im Französischen mit pour le moment eine feste, neutrale Zeitformel: für den Moment.' },
  placeholderMedia: { type: 'video', caption: 'Letzter kurzer Abschluss des 100-Lektionen-Bogens.' },
  songSeed: { genre: 'closing acoustic', mood: 'polite final goodbye' },
...
export const GUIDED_LESSONS: GuidedLessonDefinition[] = [
  ...
  },
  {
    ...
    title: 'Können Sie das aufschreiben?',
    situation: {
      en: 'At a counter, ask politely to have a name, address, or price written down here.',
      de: 'An der Theke bittest du, eine wichtige Angabe hier aufzuschreiben.',
    },
  ...
  },
  {
    ...
    pedagogicalGoal: 'An der Kasse höflich nach Kartenzahlung fragen mit der iberischen unpersönlichen se-Form.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: {
      title: 'Eine Tüte und die Quittung, bitte',
      situation: 'Du bittest um Tüte und Quittung am Ende des Einkaufs.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    title: 'Eine Tüte und die Quittung, bitte',
    situation: {
      en: 'At the till, ask politely for a bag and a receipt with your purchase.',
      de: 'An der Kasse bittest du höflich um eine Tüte und die Quittung.',
    },
    pedagogicalGoal: 'Um eine Tüte und die Quittung am Ende eines kleinen Einkaufs bitten.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
  ...
  },
  {
    ...
    pathId: GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA.level,
    lessonNumber: 1,
    baseLanguage: GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA.baseLanguage,
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_FIVE_METADATA,
    lessonMetadata: {
      id: 'french-a1-practical-5-lesson-1-pour-le-retard',
      sequence: 1,
      title: 'Zu spät angekommen',
    },
    title: 'Zu spät angekommen',
    situation: {
    ...
    pedagogicalGoal: 'Eine kurze Entschuldigung mit désolé pour le retard abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: {
      title: 'Ich habe es vergessen',
      situation: 'Du sagst, dass du etwas vergessen hast.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Eine kleine Panne mit j’ai oublié und einem einfachen Gegenstand benennen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      title: 'Dein Vorname',
      situation: 'Du fragst in einer lockeren Vorstellung nach dem Vornamen.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Die informelle Namensfrage mit ton prénom und tu-Schiene verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      title: 'Freut mich',
      situation: 'Du antwortest freundlich nach der Vorstellung.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Die französische Vorstellungsformel enchanté sicher abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      ...
      situation: 'Du fragst in einem lockeren Gespräch nach Herkunft.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Eine informelle Herkunftsfrage mit tu viens d’où bilden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      ...
      situation: 'Du fragst nach dem Wohnort.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Die informelle Wohnortfrage mit tu habites à Paris abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      ...
      situation: 'Du fragst nach Verfügbarkeit heute Abend.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Eine informelle Verfügbarkeitsfrage mit ce soir abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: {
      title: 'Treffen im Park',
      situation: 'Du schlägst einen konkreten Treffpunkt vor.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Einen Treffvorschlag mit on se voit au parc formulieren.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      ...
      situation: 'Du verschiebst einen Plan weich auf morgen.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Eine weiche Verschiebung mit peut-être demain abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      title: 'Bis morgen',
      situation: 'Du verabschiedest dich mit Blick auf morgen.',
    },
    vibeVariants: {
  ...
  },
  {
    ...
    pedagogicalGoal: 'Eine Abschiedsformel mit à demain und au revoir abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    ...
    nextLessonTeaser: {
      title: 'Pfad abgeschlossen',
      situation: 'Du hast French A1 Practical 5 abgeschlossen.',
    },
    vibeVariants: {
  ...
  {
    id: 'french-a1-practical-8-lesson-1-reservation-a-lhotel',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 1,
    baseLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.baseLanguage,
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-1-reservation-a-lhotel', sequence: 1, title: 'Reservierung im Hotel' },
    title: 'Reservierung im Hotel',
    situation: {
      en: 'At hotel reception, open check-in by saying you have a reservation.',
      de: 'An der Hotelrezeption eröffnest du den Check-in mit deiner Reservierung.',
    },
    pedagogicalGoal: 'Eine hotelbezogene Check-in-Eröffnung mit l’hôtel-Elision abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Ein Zimmer', situation: 'Du fragst ohne Buchung nach einem Zimmer.' },
    vibeVariants: { bright: brightFrenchP8Lesson001 },
  },
  {
    id: 'french-a1-practical-8-lesson-2-une-chambre',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 2,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-2-une-chambre', sequence: 2, title: 'Ein Zimmer' },
    title: 'Ein Zimmer',
    situation: {
      en: 'At a hotel or guesthouse desk, ask for a room without a prior booking.',
      de: 'Im Hotel oder in einer Pension fragst du ohne vorherige Buchung nach einem Zimmer.',
    },
    pedagogicalGoal: 'Je voudrais une chambre als höfliche Walk-in-Bitte verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Welche Etage?', situation: 'Du fragst nach der Lage deines Zimmers.' },
    vibeVariants: { bright: brightFrenchP8Lesson002 },
  },
  {
    id: 'french-a1-practical-8-lesson-3-a-quel-etage',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 3,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-3-a-quel-etage', sequence: 3, title: 'Welche Etage?' },
    title: 'Welche Etage?',
    situation: {
      en: 'After check-in, ask which floor your room is on.',
      de: 'Nach dem Check-in fragst du, auf welcher Etage dein Zimmer ist.',
    },
    pedagogicalGoal: 'À quel étage mit ma chambre in einer Hotel-Ortsfrage abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Der Schlüssel', situation: 'Du bittest an der Rezeption um den Zimmerschlüssel.' },
    vibeVariants: { bright: brightFrenchP8Lesson003 },
  },
  {
    id: 'french-a1-practical-8-lesson-4-la-cle',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 4,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-4-la-cle', sequence: 4, title: 'Der Schlüssel' },
    title: 'Der Schlüssel',
    situation: {
      en: 'At the front desk, ask for the room key.',
      de: 'An der Rezeption bittest du um den Zimmerschlüssel.',
    },
    pedagogicalGoal: 'La clé de la chambre als knappe höfliche Bitte produktiv machen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'WLAN', situation: 'Du fragst, ob es WLAN gibt.' },
    vibeVariants: { bright: brightFrenchP8Lesson004 },
  },
  {
    id: 'french-a1-practical-8-lesson-5-wifi',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 5,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-5-wifi', sequence: 5, title: 'WLAN' },
    title: 'WLAN',
    situation: {
      en: 'In the hotel lobby or room, ask if Wi-Fi is available.',
      de: 'In Lobby oder Zimmer fragst du, ob es WLAN gibt.',
    },
    pedagogicalGoal: 'Wi-Fi mit il y a in einer einfachen Verfügbarkeitsfrage abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Toiletten', situation: 'Du fragst höflich nach den Toiletten.' },
    vibeVariants: { bright: brightFrenchP8Lesson005 },
  },
  {
    id: 'french-a1-practical-8-lesson-6-les-toilettes',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 6,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-6-les-toilettes', sequence: 6, title: 'Toiletten' },
    title: 'Toiletten',
    situation: {
      en: 'In a hotel, guesthouse, or restaurant, ask where the bathroom is.',
      de: 'In Hotel, Pension oder Restaurant fragst du, wo die Toiletten sind.',
    },
    pedagogicalGoal: 'Où sont les toilettes mit französischem Pluralgebrauch abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Ein Handtuch', situation: 'Du bittest um ein Handtuch.' },
    vibeVariants: { bright: brightFrenchP8Lesson006 },
  },
  {
    id: 'french-a1-practical-8-lesson-7-une-serviette',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 7,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-7-une-serviette', sequence: 7, title: 'Ein Handtuch' },
    title: 'Ein Handtuch',
    situation: {
      en: 'In your room or at the front desk, ask politely for a towel.',
      de: 'Im Zimmer oder an der Rezeption bittest du höflich um ein Handtuch.',
    },
    pedagogicalGoal: 'Une serviette als Hotelbitte mit s’il vous plaît verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Schlafen gehen', situation: 'Du sagst, dass du schlafen gehst.' },
    vibeVariants: { bright: brightFrenchP8Lesson007 },
  },
  {
    id: 'french-a1-practical-8-lesson-8-je-vais-dormir',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 8,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-8-je-vais-dormir', sequence: 8, title: 'Schlafen gehen' },
    title: 'Schlafen gehen',
    situation: {
      en: 'In the hotel room or with a companion, say you are going to sleep.',
      de: 'Im Hotelzimmer oder mit einer Begleitperson sagst du, dass du schlafen gehst.',
    },
    pedagogicalGoal: 'Je vais dormir als einfache End-of-day-Aussage verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Frühstückszeit', situation: 'Du fragst nach der Frühstückszeit.' },
    vibeVariants: { bright: brightFrenchP8Lesson008 },
  },
  {
    id: 'french-a1-practical-8-lesson-9-petit-dejeuner',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 9,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-9-petit-dejeuner', sequence: 9, title: 'Frühstückszeit' },
    title: 'Frühstückszeit',
    situation: {
      en: 'At the hotel desk, ask what time breakfast is.',
      de: 'An der Hotelrezeption fragst du, um wie viel Uhr das Frühstück ist.',
    },
    pedagogicalGoal: 'À quelle heure est le petit-déjeuner als Hotel-Zeitfrage abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Abreise heute', situation: 'Du eröffnest den Check-out.' },
    vibeVariants: { bright: brightFrenchP8Lesson009 },
  },
  {
    id: 'french-a1-practical-8-lesson-10-je-pars-aujourdhui',
    pathId: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.level,
    lessonNumber: 10,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_EIGHT_METADATA,
    lessonMetadata: { id: 'french-a1-practical-8-lesson-10-je-pars-aujourdhui', sequence: 10, title: 'Abreise heute' },
    title: 'Abreise heute',
    situation: {
      en: 'At the hotel desk, open checkout by saying you are leaving today.',
      de: 'An der Hotelrezeption eröffnest du den Check-out, indem du sagst, dass du heute abreist.',
    },
    pedagogicalGoal: 'Je pars aujourd’hui als einfache Check-out-Eröffnung ohne Rechnungsstreit verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Pfad abgeschlossen', situation: 'Du hast French A1 Practical 8 abgeschlossen.' },
    vibeVariants: { bright: brightFrenchP8Lesson010 },
  },
  {
    id: 'french-a1-practical-9-lesson-1-salut-moi-cest',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 1,
    baseLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.baseLanguage,
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-1-salut-moi-cest', sequence: 1, title: 'Lockere Vorstellung' },
    title: 'Lockere Vorstellung',
    situation: { en: 'At a casual social gathering, open with a brief greeting and first name.', de: 'Bei einem lockeren Treffen eröffnest du mit einer kurzen Begrüßung und deinem Vornamen.' },
    pedagogicalGoal: 'Salut und moi, c’est als informelle Erstvorstellung verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Heute Zeit?', situation: 'Du fragst, ob jemand heute Zeit hat.' },
    vibeVariants: { bright: brightFrenchP9Lesson001 },
  },
  {
    id: 'french-a1-practical-9-lesson-2-aujourdhui',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 2,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-2-aujourdhui', sequence: 2, title: 'Heute Zeit?' },
    title: 'Heute Zeit?',
    situation: { en: 'In casual planning, ask whether the other person has time today.', de: 'In lockerer Planung fragst du, ob die andere Person heute Zeit hat.' },
    pedagogicalGoal: 'Tu as du temps aujourd’hui als allgemeine Tagesfrage abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Später treffen', situation: 'Du schlägst ein Treffen später am selben Tag vor.' },
    vibeVariants: { bright: brightFrenchP9Lesson002 },
  },
  {
    id: 'french-a1-practical-9-lesson-3-plus-tard',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 3,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-3-plus-tard', sequence: 3, title: 'Später treffen' },
    title: 'Später treffen',
    situation: { en: 'Suggest meeting later the same day.', de: 'Du schlägst vor, euch später am selben Tag zu treffen.' },
    pedagogicalGoal: 'On se voit plus tard als lockeren Same-day-Vorschlag verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Welche Uhrzeit?', situation: 'Du fragst, welche Uhrzeit passt.' },
    vibeVariants: { bright: brightFrenchP9Lesson003 },
  },
  {
    id: 'french-a1-practical-9-lesson-4-quelle-heure',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 4,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-4-quelle-heure', sequence: 4, title: 'Welche Uhrzeit?' },
    ...
    pedagogicalGoal: 'Ça te va à quelle heure im vertrauten tu-Register abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Treffpunkt hier', situation: 'Du schlägst den aktuellen Ort als Treffpunkt vor.' },
    vibeVariants: { bright: brightFrenchP9Lesson004 },
  },
  {
    id: 'french-a1-practical-9-lesson-5-rendez-vous-ici',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 5,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-5-rendez-vous-ici', sequence: 5, title: 'Treffpunkt hier' },
    title: 'Treffpunkt hier',
    situation: { en: 'Suggest the current location as the meeting place.', de: 'Du schlägst den aktuellen Ort als Treffpunkt vor.' },
    pedagogicalGoal: 'Rendez-vous ici als knappen Treffpunktvorschlag verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Draußen warten', situation: 'Du sagst, dass du draußen wartest.' },
    vibeVariants: { bright: brightFrenchP9Lesson005 },
  },
  {
    id: 'french-a1-practical-9-lesson-6-jattends-dehors',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 6,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-6-jattends-dehors', sequence: 6, title: 'Draußen warten' },
    title: 'Draußen warten',
    situation: { en: 'By phone or message, say you are waiting outside.', de: 'Am Telefon oder per Nachricht sagst du, dass du draußen wartest.' },
    pedagogicalGoal: 'J’attends dehors mit Pflichtelision von je abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Spät dran', situation: 'Du schickst eine kurze Verspätungsnachricht.' },
    vibeVariants: { bright: brightFrenchP9Lesson006 },
  },
  {
    id: 'french-a1-practical-9-lesson-7-desole-tard',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 7,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-7-desole-tard', sequence: 7, title: 'Spät dran' },
    title: 'Spät dran',
    situation: { en: 'Send a simple update that you will arrive late.', de: 'Du schickst eine einfache Nachricht, dass du spät ankommen wirst.' },
    pedagogicalGoal: 'Désolé und je vais arriver tard als kurze Verspätungsinfo verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Plan ändern', situation: 'Du fragst, ob ihr den Plan ändern könnt.' },
    vibeVariants: { bright: brightFrenchP9Lesson007 },
  },
  {
    id: 'french-a1-practical-9-lesson-8-changer-le-plan',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 8,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-8-changer-le-plan', sequence: 8, title: 'Plan ändern' },
    title: 'Plan ändern',
    situation: { en: 'In casual planning, ask to change a simple existing plan.', de: 'In lockerer Planung fragst du, ob ihr einen einfachen Plan ändern könnt.' },
    pedagogicalGoal: 'On peut changer le plan als einfache Planänderungsfrage abrufen.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Morgen Mittag', situation: 'Du schließt die Planung für morgen Mittag ab.' },
    vibeVariants: { bright: brightFrenchP9Lesson008 },
  },
  {
    id: 'french-a1-practical-9-lesson-9-a-demain-midi',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 9,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-9-a-demain-midi', sequence: 9, title: 'Morgen Mittag' },
    title: 'Morgen Mittag',
    situation: { en: 'Close a casual planning conversation with see you tomorrow at noon.', de: 'Du beendest eine lockere Planung mit Bis morgen Mittag.' },
    pedagogicalGoal: 'À demain midi als konkrete soziale Abschiedsformel verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Schönen Abend', situation: 'Du verabschiedest dich höflich am Abend.' },
    vibeVariants: { bright: brightFrenchP9Lesson009 },
  },
  {
    id: 'french-a1-practical-9-lesson-10-bonne-soiree',
    pathId: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.level,
    lessonNumber: 10,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_NINE_METADATA,
    lessonMetadata: { id: 'french-a1-practical-9-lesson-10-bonne-soiree', sequence: 10, title: 'Schönen Abend' },
    title: 'Schönen Abend',
    situation: { en: 'At the end of an evening social or service interaction, say have a good evening.', de: 'Am Ende eines abendlichen sozialen oder Service-Kontakts wünschst du einen schönen Abend.' },
    pedagogicalGoal: 'Bonne soirée als höfliche Abend-Abschiedsformel von bonne nuit unterscheiden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Pfad abgeschlossen', situation: 'Du hast French A1 Practical 9 abgeschlossen.' },
    vibeVariants: { bright: brightFrenchP9Lesson010 },
  },
  {
    id: 'french-a1-practical-10-lesson-1-bonne-journee',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 1,
    baseLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.baseLanguage,
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-1-bonne-journee', sequence: 1, title: 'Guter Tag' },
    title: 'Guter Tag',
    situation: { en: 'At the end of the day, say the day was good.', de: 'Am Ende des Tages sagst du, dass es ein guter Tag war.' },
    pedagogicalGoal: "C'était une bonne journée als kurze positive Rückschau verwenden.",
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Schön hier', situation: 'Du sagst beim Weggehen etwas Positives über einen Ort.' },
    vibeVariants: { bright: brightFrenchP10Lesson001 },
  },
  {
    id: 'french-a1-practical-10-lesson-2-bien-ici',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 2,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-2-bien-ici', sequence: 2, title: 'Schön hier' },
    title: 'Schön hier',
    situation: { en: 'Before leaving a café, museum, or social place, say it was nice here.', de: 'Beim Verlassen eines Cafés, Museums oder Treffpunkts sagst du, dass es schön hier war.' },
    pedagogicalGoal: "C'était bien ici als kurze Abschieds-Bewertung eines Ortes verwenden.",
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Danke für die Hilfe', situation: 'Du bedankst dich höflich für Hilfe.' },
    vibeVariants: { bright: brightFrenchP10Lesson002 },
  },
  {
    id: 'french-a1-practical-10-lesson-3-votre-aide',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 3,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-3-votre-aide', sequence: 3, title: 'Danke für die Hilfe' },
    title: 'Danke für die Hilfe',
    situation: { en: 'At the end of a service or social interaction, thank someone for their help.', de: 'Am Ende einer Service- oder sozialen Situation bedankst du dich für Hilfe.' },
    pedagogicalGoal: 'Merci pour votre aide mit höflichem votre sicher verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Viel gelernt', situation: 'Du blickst kurz auf das Gelernte zurück.' },
    vibeVariants: { bright: brightFrenchP10Lesson003 },
  },
  {
    id: 'french-a1-practical-10-lesson-4-beaucoup-appris',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 4,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-4-beaucoup-appris', sequence: 4, title: 'Viel gelernt' },
    title: 'Viel gelernt',
    situation: { en: 'At the end of a day or class, say you learned a lot.', de: 'Am Ende eines Tages oder Kurses sagst du, dass du viel gelernt hast.' },
    pedagogicalGoal: "J'ai beaucoup appris als einfache Rückschau mit Pflichtelision verwenden.",
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Jetzt müde', situation: 'Du sagst schlicht, dass du jetzt müde bist.' },
    vibeVariants: { bright: brightFrenchP10Lesson004 },
  },
  {
    id: 'french-a1-practical-10-lesson-5-fatigue-maintenant',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 5,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-5-fatigue-maintenant', sequence: 5, title: 'Jetzt müde' },
    title: 'Jetzt müde',
    situation: { en: 'At the end of the day, say you are tired now without drama.', de: 'Am Ende des Tages sagst du undramatisch, dass du jetzt müde bist.' },
    pedagogicalGoal: 'Je suis fatigué maintenant mit geschlechtsmarkierter Schreibweise verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Ich muss gehen', situation: 'Du kündigst deinen Aufbruch an.' },
    vibeVariants: { bright: brightFrenchP10Lesson005 },
  },
  {
    id: 'french-a1-practical-10-lesson-6-y-aller',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 6,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-6-y-aller', sequence: 6, title: 'Ich muss gehen' },
    title: 'Ich muss gehen',
    situation: { en: 'At the end of an interaction, signal that you need to leave.', de: 'Am Ende einer Interaktion sagst du, dass du gehen musst.' },
    pedagogicalGoal: 'Je dois y aller als neutrale Aufbruchsformel verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Bis zum nächsten Mal', situation: 'Du verabschiedest dich ohne festen nächsten Termin.' },
    vibeVariants: { bright: brightFrenchP10Lesson006 },
  },
  {
    id: 'french-a1-practical-10-lesson-7-a-la-prochaine',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 7,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-7-a-la-prochaine', sequence: 7, title: 'Bis zum nächsten Mal' },
    title: 'Bis zum nächsten Mal',
    situation: { en: 'At the end of an interaction with no fixed next meeting, say see you next time.', de: 'Am Ende einer Interaktion ohne festen Folgetermin sagst du bis zum nächsten Mal.' },
    pedagogicalGoal: 'À la prochaine als offenen Abschied von à demain unterscheiden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Morgen passt', situation: 'Du bestätigst einen Vorschlag für morgen.' },
    vibeVariants: { bright: brightFrenchP10Lesson007 },
  },
  {
    id: 'french-a1-practical-10-lesson-8-ca-me-va',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 8,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-8-ca-me-va', sequence: 8, title: 'Morgen passt' },
    title: 'Morgen passt',
    situation: { en: 'In casual planning, confirm that tomorrow works for you.', de: 'In einer lockeren Planung bestätigst du, dass morgen passt.' },
    pedagogicalGoal: 'Demain, ça me va als vertraute Planungsbestätigung verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Gute Nacht', situation: 'Du verabschiedest dich vor der Nacht.' },
    vibeVariants: { bright: brightFrenchP10Lesson008 },
  },
  {
    id: 'french-a1-practical-10-lesson-9-bonne-nuit',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 9,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-9-bonne-nuit', sequence: 9, title: 'Gute Nacht' },
    title: 'Gute Nacht',
    situation: { en: 'At the end of the evening, close with have a good night.', de: 'Am Ende des Abends verabschiedest du dich mit Gute Nacht.' },
    pedagogicalGoal: 'Bonne nuit klar von bonne soirée unterscheiden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
    status: 'active',
    nextLessonTeaser: { title: 'Für den Moment', situation: 'Du schließt den ganzen Pfad höflich ab.' },
    vibeVariants: { bright: brightFrenchP10Lesson009 },
  },
  {
    id: 'french-a1-practical-10-lesson-10-pour-le-moment',
    pathId: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.id,
    courseTitle: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.title,
    level: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.level,
    lessonNumber: 10,
    ...
    targetLanguage: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA.targetLanguage,
    pathMetadata: GUIDED_TODAY_PATH_FRENCH_TEN_METADATA,
    lessonMetadata: { id: 'french-a1-practical-10-lesson-10-pour-le-moment', sequence: 10, title: 'Für den Moment' },
    title: 'Für den Moment',
    situation: { en: 'At the end of the 100-lesson arc, say a short polite goodbye for now.', de: 'Am Ende des 100-Lektionen-Bogens sagst du kurz und höflich Auf Wiedersehen für den Moment.' },
    pedagogicalGoal: 'Au revoir pour le moment als Meta-Abschluss des Pfads verwenden.',
    modeSet: 'guided-today-v0',
    steps: GUIDED_TODAY_STEPS,
    estimatedMinutes: 5,
    fallbackVibeId: DEFAULT_GUIDED_VIBE_ID,
