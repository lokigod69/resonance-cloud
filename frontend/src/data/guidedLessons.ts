...
const a1Practical2Inputs: A1P2LessonInput[] = [
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        baseText: "Entschuldigung, ich verstehe das nicht. Könnten Sie mir helfen?",
        ...
        sceneCaption: "Wistful gibt kurz zu, dass der Sinn fehlt, und lässt die Bitte ruhig stehen.",
        trophyWord: trophy('gently', 'sanft', 'Gently, please.', 'Gently hält die Bitte weich und trotzdem praktisch.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        baseText: "Könnten Sie es für mich aufschreiben?",
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('quick', 'schnell', 'Quick note, please.', 'Quick hält den Moment kurz und zielgerichtet.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('ready', 'bereit', 'Ready to choose.', 'Ready hält die Wahl kurz und handlungsnah.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        trophyWord: trophy('soft', 'sanft', 'Soft answer, thank you.', 'Soft hält die Frage vorsichtig, aber nutzbar.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        baseText: "Könnte ich vielleicht mit Karte bezahlen?",
        ...
        trophyWord: trophy('again', 'noch einmal', 'Again, please.', 'Again bleibt ein nützliches Reparaturwort im Bezahlmoment.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        sceneCaption: "Wistful hält kurz inne und fuegt die Tuete vorsichtig hinzu.",
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('settled', 'geklärt', 'Settled, thanks.', 'Settled ist der Zustand nach der schnellen Bestätigung.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('done', 'fertig', 'Done. Thanks.', 'Done schließt die kurze Pause klar ab.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        trophyWord: trophy('slowly', 'langsam', 'Slowly is okay.', 'Slowly hält die Frage ruhig und koerperlich realistisch.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        meaning: "Eine vorsichtige Nachfrage, ob noch geoeffnet ist.",
        chunks: [
          chunk('just-checking', 'Just checking', 'nur zur Sicherheit'),
          chunk('are-they-still-open', 'are they still open', 'sind sie noch geoeffnet'),
        ],
        ...
        trophyWord: trophy('careful', 'vorsichtig', 'A careful hours check.', 'Careful hält den Ton pruefend und freundlich.'),
      ...
      sharp: createA1P3VariantInput({
        ...
        chunks: [
          chunk('open-now', 'Open now', 'jetzt geoeffnet'),
        ],
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        chunks: [
          chunk('is-this-the-right-bus', 'Is this the right bus', 'faehrt dieser Bus'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P3VariantInput({
        ...
        sceneCaption: "Sharp bestaetigt und bewegt sich zur Tür.",
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P3VariantInput({
        ...
        trophyWord: trophy('corner', 'Ecke', 'Corner meeting.', 'Corner ist für klare Treffpunkte ein starkes Basiswort.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        baseText: "Vielleicht können wir bitte zu Fuss gehen oder ein Taxi nehmen?",
        meaning: "Eine sanfte Wahl, wenn beide Wege moeglich sind.",
        chunks: [
          chunk('maybe-we-can-walk', 'Maybe we can walk', 'vielleicht können wir zu Fuss gehen'),
          chunk('or-take-a-taxi', 'or take a taxi', 'oder ein Taxi nehmen'),
        ],
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P3VariantInput({
        ...
        chunks: [
          chunk('i-missed-my-stop', 'I missed my stop', 'ich habe meine Haltestelle verpasst'),
          chunk('whats-next', "What's next", 'was kommt als Naechstes'),
        ],
