...
const a1Practical9Inputs: A1P9LessonInput[] = [
  {
    ...
    variants: {
      bright: createA1P9VariantInput({
        targetText: 'Nice to meet you.',
        baseText: 'Schön, Sie kennenzulernen.',
        meaning: 'Ein freundlicher Satz, wenn du jemanden neu triffst.',
        chunks: [
          chunk('nice-to', 'Nice to', 'schön zu'),
        ...
        typeRecall: recall('Nice to ', 'meet', ' you.', ['meet', 'wait', 'change', 'arrive']),
        sceneCaption: 'Bright begrüßt die neue Person offen und freundlich.',
        trophyWord: trophy('meet', 'treffen', 'Nice to meet you.', 'Meet ist der klare Anker für eine erste Begegnung.'),
      ...
      wistful: createA1P9VariantInput({
        ...
        trophyWord: trophy('careful', 'vorsichtig', 'A careful hello is okay.', 'Careful passt zu einem sanften ersten Treffen.'),
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('ready', 'bereit', 'I am ready to meet you.', 'Ready hält den Start klar und menschlich.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P9VariantInput({
        ...
        trophyWord: trophy('today', 'heute', 'Do you have time today?', 'Today macht die Frage konkret und einfach.'),
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('clear', 'klar', 'A clear time question helps.', 'Clear passt zur direkten Verfügbarkeitsfrage.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('there', 'dort', "Let's meet there later.", 'There hilft bei klarer sozialer Koordination.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P9VariantInput({
        targetText: 'What time is good for you?',
        baseText: 'Welche Uhrzeit ist gut für Sie?',
        meaning: 'Eine sanfte Frage nach einer passenden Zeit.',
        chunks: [
          chunk('what-time', 'What time', 'welche Uhrzeit'),
          chunk('is-good-for-you', 'is good for you', 'ist gut für Sie'),
        ],
        extraLessonItems: [
          chunk('works', 'works', 'passt'),
          chunk('time', 'time', 'Zeit'),
        ...
        targetChips: ['What time', 'is good for you?'],
        distractors: ['is the station?', 'is my room?'],
        typeRecall: recall('What time is ', 'good', ' for you?', ['good', 'late', 'outside', 'ready']),
  ...
  },
  {
    ...
    variants: {
      bright: createA1P9VariantInput({
        ...
        trophyWord: trophy('here', 'hier', "Let's meet here.", 'Here macht den Treffpunkt sofort konkret.'),
      ...
      wistful: createA1P9VariantInput({
        ...
        trophyWord: trophy('place', 'Ort', 'This place is okay.', 'Place hilft beim einfachen Vereinbaren eines Treffpunkts.'),
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('right', 'richtig', 'This is the right place.', 'Right passt zur klaren Ortsentscheidung.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('wait', 'warten', 'I can wait outside.', 'Wait passt zur klaren Ortsmeldung.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P9VariantInput({
        ...
        trophyWord: trophy('help', 'Hilfe', 'Thanks for your help and patience.', 'Help passt zur vorsichtigen sozialen Meldung.'),
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('quick', 'schnell', 'A quick late update helps.', 'Quick passt zu einer kurzen Statusmeldung.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('direct', 'direkt', 'We need a direct plan.', 'Direct passt zur direkten sozialen Abstimmung.'),
  ...
  },
  {
    ...
    variants: {
      bright: createA1P9VariantInput({
        ...
        trophyWord: trophy('tomorrow', 'morgen', 'See you tomorrow.', 'Tomorrow ist ein einfacher Planungsanker.'),
      ...
      wistful: createA1P9VariantInput({
        ...
        trophyWord: trophy('morning', 'Morgen', 'Tomorrow morning works.', 'Morning knüpft an den nächsten Tag an.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P9VariantInput({
        ...
        trophyWord: trophy('good', 'gut', 'Have a good evening.', 'Good hält den Abschied einfach und freundlich.'),
      ...
      sharp: createA1P9VariantInput({
        ...
        trophyWord: trophy('done', 'fertig', 'The plan is done.', 'Done passt zum klaren Abschluss der Begegnung.'),
...
const a1Practical10Inputs: A1P10LessonInput[] = [
  {
    ...
    variants: {
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('ready', 'bereit', 'I am ready to finish the day.', 'Ready passt zum klaren Abschluss.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('here', 'hier', 'It was nice here.', 'Here verbindet den Ort mit der echten Szene.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('there', 'dort', 'It was good there.', 'There hilft, den Ort knapp zu benennen.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('help', 'Hilfe', 'Thank you for helping me.', 'Help hält den Dank praktisch und konkret.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('clear', 'klar', 'A clear thank-you helps.', 'Clear passt zu einem knappen höflichen Dank.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('slowly', 'langsam', 'I learned slowly.', 'Slowly passt zu einem sanften Lernabschluss.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('better', 'besser', 'That helped me learn better.', 'Better verbindet Lernen mit einem klaren Fortschritt.'),
  ...
  },
  {
    ...
    variants: {
      bright: createA1P10VariantInput({
        ...
        trophyWord: trophy('tired', 'müde', 'I am tired now.', 'Tired ist ein praktischer A1-Anker am Tagesende.'),
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('evening', 'Abend', 'I feel tired this evening.', 'Evening passt zum müden Tagesabschluss.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('time', 'Zeit', 'It is time to rest.', 'Time passt zum knappen Ende des Tages.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('ready', 'bereit', 'I am ready to go.', 'Ready hält den Aufbruch weich und klar.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('leave', 'gehen', 'I have to leave now.', 'Leave ist ein klarer Anker für den Abschluss.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('set', 'fest', 'Next time is set.', 'Set passt zur klaren sozialen Bestätigung.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('morning', 'Morgen', 'Tomorrow morning is okay.', 'Morning knüpft den Plan an den nächsten Tag.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('rest', 'Ruhe', 'I hope you rest well.', 'Rest passt zum sanften Nachtabschluss.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('done', 'fertig', 'The day is done.', 'Done passt zum klaren Ende des Tages.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P10VariantInput({
        ...
        trophyWord: trophy('calm', 'ruhig', 'A calm goodbye is enough.', 'Calm hält den letzten Abschied ruhig und menschlich.'),
      ...
      sharp: createA1P10VariantInput({
        ...
        trophyWord: trophy('now', 'jetzt', 'Goodbye for now.', 'Now hält den letzten Abschluss praktisch.'),
