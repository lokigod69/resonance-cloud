  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P2VariantInput({
        ...
        meaning: "Eine vorsichtige Frage, ob etwas verfügbar ist.",
        chunks: [
          chunk('do-you-have', 'Do you have', 'haben Sie'),
          chunk('this', 'this', 'das hier'),
          chunk('perhaps', 'perhaps', 'vielleicht'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('straight', 'direkt', 'Straight to payment.', 'Straight beschreibt die direkte Zahlungslösung.'),
    ...
    variants: {
      ...
      wistful: createA1P5VariantInput({
        ...
        chunks: [
          ...
          chunk('are-you-free-tonight', 'are you free tonight', 'hast du heute Abend Zeit'),
        ],
        extraLessonItems: [
          chunk('later', 'later', 'später'),
          chunk('busy', 'busy', 'beschäftigt'),
  ...
  },
  {
    ...
    variants: {
      bright: createA1P5VariantInput({
        ...
        targetChips: ['Maybe tomorrow', 'instead?'],
        distractors: ['hopeful', 'tonight'],
        typeRecall: recall('', 'Maybe tomorrow', ' instead?', ['Maybe tomorrow', 'next time', 'later', 'another day']),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P5VariantInput({
        ...
        targetChips: ['See you tomorrow,', 'then.'],
        distractors: ['then', 'tonight'],
        typeRecall: recall('', 'See you tomorrow', ', then.', ['See you tomorrow', 'until then', 'tomorrow', 'bye']),
