  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('note', 'Notiz', 'Note, please.', 'Note ist Sharps direkter Befehl für die schriftliche Information.'),
        mediaCaption: "Schalterkante, Stift, kurze Notiz, keine Umwege.",
        songSeed: { genre: 'staccato piano groove', mood: 'short note' },
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('here', 'hier', 'Here, please.', 'Here ist Sharps direktes Zeigen ohne Erklärung — Punkt und Schluss.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('this', 'das hier / dieses', 'This one.', 'This ist Sharps eindeutige Wahl ohne weitere Erklärung.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('any', 'irgendein / welche', 'Any in stock?', 'Any ist Sharps direkter Verfügbarkeitscheck ohne Umweg.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('two', 'zwei', 'Two, please.', 'Two ist Sharps knapper Listenton an der Kasse — beide Dinge in einem Wort.'),
  ...
  },
  {
    ...
    variants: {
      ...
      sharp: createA1P2VariantInput({
        ...
        trophyWord: trophy('yes', 'ja', 'Yes. This one.', 'Yes ist Sharps direkte Bestätigung der richtigen Wahl.'),
...
const a1Practical8Inputs: A1P8LessonInput[] = [
  {
    ...
    variants: {
      ...
      sharp: createA1P8VariantInput({
        ...
        trophyWord: trophy('ready', 'bereit', 'I am ready to check in.', 'Ready h?lt den Check-in praktisch und ruhig.'),
  ...
  },
  {
    ...
    situation: {
      ...
      de: 'Du fragst in einem Hotel oder G?stehaus nach einem Zimmer.',
    },
    ...
    variants: {
      bright: createA1P8VariantInput({
        ...
        mediaCaption: 'Hotelrezeption mit Zimmerschl?ssel, freundliche Bitte.',
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'K?nnte ich ein ruhiges Zimmer haben?',
        meaning: 'Eine vorsichtige Bitte um ein ruhiges Zimmer.',
        chunks: [
          chunk('could-i-have', 'Could I have', 'k?nnte ich haben'),
        ...
        mediaCaption: 'Ged?mpfter Hotelflur, ruhige Bitte um ein Zimmer.',
      ...
      sharp: createA1P8VariantInput({
        ...
        baseText: 'Ich brauche ein Zimmer f?r heute Nacht.',
        meaning: 'Eine direkte, klare Zimmerbitte.',
        chunks: [
          chunk('i-need', 'I need', 'ich brauche'),
          chunk('a-room', 'a room', 'ein Zimmer'),
          chunk('for-tonight', 'for tonight', 'f?r heute Nacht'),
        ],
        extraLessonItems: [
          chunk('hotel', 'hotel', 'Hotel'),
          chunk('room', 'room', 'Zimmer'),
        ...
        sceneCaption: 'Sharp nennt den Bedarf direkt und h?flich.',
        trophyWord: trophy('hotel', 'Hotel', 'I need a hotel room.', 'Hotel h?lt die Szene klar verortet.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'K?nnten Sie mir mein Zimmer zeigen?',
        meaning: 'Eine sanfte Bitte, das Zimmer zu zeigen.',
        chunks: [
          chunk('could-you-show-me', 'Could you show me', 'k?nnten Sie mir zeigen'),
          chunk('my-room', 'my room', 'mein Zimmer'),
        ],
        extraLessonItems: [
          chunk('where', 'where', 'wo'),
      ...
      sharp: createA1P8VariantInput({
        ...
        meaning: 'Eine direkte, h?fliche Bitte um den Weg.',
        chunks: [
          chunk('please-show-me', 'Please show me', 'bitte zeigen Sie mir'),
  ...
  },
  {
    ...
    situation: {
      ...
      de: 'An der Rezeption fragst du nach dem Zimmerschl?ssel.',
    },
    pedagogicalGoal: 'Ask for the key with a short hotel phrase.',
    variants: {
      bright: createA1P8VariantInput({
        targetText: 'I need the key, please.',
        baseText: 'Ich brauche den Schl?ssel, bitte.',
        meaning: 'Eine freundliche Bitte um den Schl?ssel.',
        chunks: [
          chunk('i-need', 'I need', 'ich brauche'),
          chunk('the-key', 'the key', 'den Schl?ssel'),
          chunk('please', 'please', 'bitte'),
        ],
        extraLessonItems: [
          chunk('key', 'key', 'Schl?ssel'),
          chunk('room', 'room', 'Zimmer'),
          chunk('please', 'please', 'bitte'),
          chunk('ready', 'ready', 'bereit'),
        ],
        ...
        sceneCaption: 'Bright bittet freundlich um den Schl?ssel.',
        trophyWord: trophy('key', 'Schl?ssel', 'I need the key.', 'Key ist der praktische Zimmeranker.'),
        mediaCaption: 'Zimmerschl?ssel an der Rezeption, freundliche Bitte.',
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'K?nnte ich den Schl?ssel haben?',
        meaning: 'Eine vorsichtige Bitte um den Schl?ssel.',
        chunks: [
          chunk('could-i-have', 'Could I have', 'k?nnte ich haben'),
          chunk('the-key', 'the key', 'den Schl?ssel'),
        ],
        ...
        sceneCaption: 'Wistful fragt sanft nach dem Schl?ssel.',
        trophyWord: trophy('help', 'Hilfe', 'Help with the key, please.', 'Help passt zur vorsichtigen Frage an der Rezeption.'),
        mediaCaption: 'Ged?mpfte Rezeption, kleine Bitte um den Schl?ssel.',
      ...
      sharp: createA1P8VariantInput({
        ...
        baseText: 'Den Schl?ssel, bitte.',
        meaning: 'Eine sehr kurze, h?fliche Bitte.',
        chunks: [
          chunk('the-key', 'The key', 'den Schl?ssel'),
          chunk('please', 'please', 'bitte'),
        ],
        ...
        sceneCaption: 'Sharp bleibt kurz, aber h?flich.',
        trophyWord: trophy('clear', 'klar', 'The key, please.', 'Clear passt zur kurzen Schl?sselbitte.'),
        mediaCaption: 'Klarer Tresen, Schl?sselkarte, kurzer h?flicher Satz.',
  ...
  },
  {
    ...
    variants: {
      bright: createA1P8VariantInput({
        ...
        trophyWord: trophy('Wi-Fi', 'WLAN', 'Is there Wi-Fi?', 'Wi-Fi ist ein h?ufiger Hotelanker.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'K?nnten Sie mir das Bad zeigen?',
        ...
        mediaCaption: 'Ged?mpfter Flur, ruhige Frage nach dem Bad.',
      ...
      sharp: createA1P8VariantInput({
        ...
        meaning: 'Eine direkte, h?fliche Bitte.',
        chunks: [
          chunk('please-show-me', 'Please show me', 'bitte zeigen Sie mir'),
          chunk('the-bathroom', 'the bathroom', 'das Bad'),
        ],
  ...
  },
  {
    ...
    variants: {
      bright: createA1P8VariantInput({
        ...
        mediaCaption: 'Hotelzimmer mit Handt?chern, freundliche Bitte.',
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'K?nnte ich ein Handtuch haben?',
        ...
        mediaCaption: 'Ged?mpftes Zimmer, leise Bitte um ein Handtuch.',
      ...
      sharp: createA1P8VariantInput({
        ...
        meaning: 'Eine kurze, h?fliche Bitte.',
        chunks: [
          chunk('a-towel', 'A towel', 'ein Handtuch'),
          chunk('please', 'please', 'bitte'),
        ],
        ...
        sceneCaption: 'Sharp bleibt knapp und h?flich.',
  ...
  },
  {
    ...
    variants: {
      bright: createA1P8VariantInput({
        ...
        sceneCaption: 'Bright sagt freundlich, dass er jetzt schlafen m?chte.',
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'Ich bin m?de und m?chte schlafen.',
        meaning: 'Ein sanfter Satz, wenn du m?de bist.',
        chunks: [
          chunk('i-am-tired', 'I am tired', 'ich bin m?de'),
          chunk('and-want', 'and want', 'und m?chte'),
          chunk('to-sleep', 'to sleep', 'schlafen'),
        ],
        extraLessonItems: [
          chunk('ready', 'ready', 'bereit'),
          chunk('tired', 'tired', 'm?de'),
          chunk('sleep', 'sleep', 'schlafen'),
          chunk('night', 'night', 'Nacht'),
        ],
        ...
        sceneCaption: 'Wistful sagt m?de, aber klar, dass er schlafen m?chte.',
        trophyWord: trophy('ready', 'bereit', 'I am ready to sleep.', 'Ready passt zum ruhigen Abschluss des Tages.'),
        mediaCaption: 'Ged?mpftes Zimmerlicht, m?de aber klare Aussage.',
      ...
      sharp: createA1P8VariantInput({
        ...
        trophyWord: trophy('night', 'Nacht', 'I need sleep tonight.', 'Night h?lt den Satz praktisch und menschlich.'),
  ...
  },
  {
    ...
    situation: {
      ...
      de: 'Du fragst nach der Fr?hst?ckszeit.',
    },
    pedagogicalGoal: 'Ask about breakfast time without extra hotel planning detail.',
    variants: {
      bright: createA1P8VariantInput({
        targetText: 'What time is breakfast?',
        baseText: 'Um wie viel Uhr ist Fr?hst?ck?',
        meaning: 'Eine klare Frage nach der Fr?hst?ckszeit.',
        chunks: [
          chunk('what-time', 'What time', 'um wie viel Uhr'),
          chunk('is-breakfast', 'is breakfast', 'ist Fr?hst?ck'),
        ],
        extraLessonItems: [
          chunk('breakfast', 'breakfast', 'Fr?hst?ck'),
        ...
        sceneCaption: 'Bright fragt freundlich nach der Fr?hst?ckszeit.',
        trophyWord: trophy('breakfast', 'Fr?hst?ck', 'What time is breakfast?', 'Breakfast ist der Morgenanker im Hotel.'),
        mediaCaption: 'Fr?hst?cksschild im Hotel, freundliche Zeitfrage.',
      ...
      wistful: createA1P8VariantInput({
        ...
        baseText: 'Wann ist Fr?hst?ck am Morgen?',
        ...
        sceneCaption: 'Wistful fragt ruhig nach dem Fr?hst?ck am Morgen.',
        trophyWord: trophy('morning', 'Morgen', 'Breakfast is in the morning.', 'Morning passt zur einfachen Fr?hst?cksfrage.'),
        mediaCaption: 'Ged?mpftes Lobbyschild, ruhige Frage zum Morgen.',
      ...
      sharp: createA1P8VariantInput({
        ...
        baseText: 'Bitte sagen Sie mir die Fr?hst?ckszeit.',
        meaning: 'Eine direkte, h?fliche Bitte um die Zeit.',
        chunks: [
          chunk('please-tell-me', 'Please tell me', 'bitte sagen Sie mir'),
          chunk('the-breakfast-time', 'the breakfast time', 'die Fr?hst?ckszeit'),
        ],
        extraLessonItems: [
          chunk('time', 'time', 'Zeit'),
          chunk('breakfast', 'breakfast', 'Fr?hst?ck'),
        ...
        sceneCaption: 'Sharp fragt direkt nach der Fr?hst?ckszeit.',
        trophyWord: trophy('time', 'Zeit', 'Breakfast time, please.', 'Time ist der kurze Anker f?r diese Frage.'),
        mediaCaption: 'Klares Schild mit Fr?hst?ckszeit, sachliche Frage.',
  ...
  },
  {
    ...
    variants: {
      bright: createA1P8VariantInput({
        ...
        trophyWord: trophy('checking out', 'auschecken', 'I am checking out.', 'Checking out schlie?t den Hotelbesuch praktisch ab.'),
      ...
      wistful: createA1P8VariantInput({
        ...
        trophyWord: trophy('arrived', 'angekommen', 'I arrived, and now I leave.', 'Arrived kn?pft an den ruhigen Reiseabschluss an.'),
        mediaCaption: 'Ged?mpfte Lobby, kurzer Abschied nach dem Aufenthalt.',
      ...
      sharp: createA1P8VariantInput({
        ...
        baseText: 'Ich m?chte auschecken.',
        meaning: 'Eine klare, h?fliche Checkout-Bitte.',
        chunks: [
          chunk('i-would-like', 'I would like', 'ich m?chte'),
        ...
        sceneCaption: 'Sharp schlie?t den Aufenthalt klar und h?flich ab.',
        trophyWord: trophy('done', 'fertig', 'I am done here.', 'Done passt zum knappen Abschluss beim Checkout.'),
        mediaCaption: 'Klarer Empfangstresen, Schl?sselr?ckgabe, direkter Abschluss.',
