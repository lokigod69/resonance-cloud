...
const brightLesson008: GuidedLessonVibeVariant = {
  ...
  lessonItems: [
    ...
    { id: "charming", targetText: "charming", baseText: "charmant", acceptedAnswers: ["charming"] },
    { id: "delighted", targetText: "delighted", baseText: "erfreut", acceptedAnswers: ["delighted"] },
  ],
  build: {
    targetText: "I love it here.",
    chips: ["I love", "it here.", "charming", "delighted", "place"],
  },
  typeRecall: {
    before: "I love it ",
    answer: "here",
    ...
    fallbackChoices: ["here", "there", "charming", "delighted"],
  },
  speakTarget: {
...
const wistfulLesson008: GuidedLessonVibeVariant = {
  ...
  build: {
    targetText: "It's quiet here. I like it.",
    chips: ["It's quiet here.", "I like it.", "soft", "almost", "again"],
  },
  typeRecall: {
    before: "It's ",
    answer: "quiet",
...
const sharpLesson008: GuidedLessonVibeVariant = {
  contentStatus: "draft",
  corePhrase: {
    targetText: "Good place. Right call.",
    baseText: "Guter Ort. Gute Wahl.",
  },
  meaning: "Ein kurzer Small-Talk-Satz mit klarer Meinung und Entscheidung.",
  chunks: [
    { id: "good-place", targetText: "Good place", baseText: "guter Ort" },
    { id: "right-call", targetText: "Right call", baseText: "gute Wahl" },
  ],
  lessonItems: [
    { id: "good", targetText: "good", baseText: "gut", acceptedAnswers: ["good"] },
    { id: "place", targetText: "place", baseText: "Ort", acceptedAnswers: ["place"] },
    { id: "right-call", targetText: "right call", baseText: "gute Wahl", acceptedAnswers: ["right call"] },
    { id: "decided", targetText: "decided", baseText: "entschieden", acceptedAnswers: ["decided"] },
    { id: "focused", targetText: "focused", baseText: "fokussiert", acceptedAnswers: ["focused"] },
  ],
  build: {
    targetText: "Good place. Right call.",
    chips: ["Good place.", "Right call.", "Decided.", "focused", "right"],
  },
  typeRecall: {
    before: "Good place. Right ",
    answer: "call",
    after: ".",
    acceptedAnswers: ["call", "Call"],
    fallbackChoices: ["call", "place", "decided", "ready"],
  },
  speakTarget: {
    baseCue: "Guter Ort. Gute Wahl.",
    targetPhrase: "Good place. Right call.",
    language: "en-US",
    passingThreshold: 0.8,
  },
  sceneCaption: "Small Talk, Sharp-Version: zwei Wörter, Meinung gesetzt.",
  trophyWord: {
    word: "decided",
    meaning: "entschieden",
