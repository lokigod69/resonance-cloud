...
const a1Practical9Inputs: A1P9LessonInput[] = [
  {
    ...
    variants: {
      bright: createA1P9VariantInput({
        targetText: "Hi, I'm glad we can meet.",
        baseText: 'Hallo, ich freue mich, dass wir uns treffen.',
        meaning: 'Ein freundlicher Satz, wenn du jemanden neu triffst.',
        chunks: [
          chunk('hi', 'Hi', 'hallo'),
          chunk('im-glad', "I'm glad", 'ich freue mich'),
          chunk('we-can-meet', 'we can meet', 'dass wir uns treffen'),
        ],
        extraLessonItems: [
          chunk('meet', 'meet', 'treffen'),
        ...
        targetChips: ['Hi,', "I'm glad", 'we can meet.'],
        distractors: ['see tomorrow', 'wait outside'],
        typeRecall: recall('Hi, I\'m glad we can ', 'meet', '.', ['meet', 'wait', 'change', 'arrive']),
