  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        trophyWord: trophy('careful', 'vorsichtig', 'A careful hours check.', 'Careful haelt den Ton pruefend und freundlich.'),
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        meaning: "Eine vorsichtige Bestaetigung, ob dieser Bus zur Altstadt faehrt.",
        chunks: [
  ...
  },
  {
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        chunks: [
          chunk('could-i-have', 'Could I have', 'koennte ich haben'),
    ...
    variants: {
      ...
      wistful: createA1P3VariantInput({
        ...
        chunks: [
          ...
          chunk('when-it-closes', 'when it closes', 'wann es schliesst'),
          chunk('today', 'today', 'heute'),
        ],
      ...
      sharp: createA1P3VariantInput({
        ...
        chunks: [
          chunk('closing-time', 'Closing time', 'Schliesszeit'),
        ],
