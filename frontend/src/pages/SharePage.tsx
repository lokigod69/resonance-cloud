...
export default function SharePage() {
  ...
  if (notFound || !data) {
    return (
      <div className="min-h-dvh bg-gray-950 flex flex-col items-center justify-center text-center px-4">
    ...
    <div className="min-h-dvh bg-gray-950 text-white">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="px-6 pt-6 pb-4 text-center">
          <h1 className="text-3xl font-bold text-white long-copy">{wordDisplay}</h1>
          {data.translation && (
            <p className="text-xl text-gray-400 mt-2 long-copy">{data.translation}</p>
          )}
          {posDisplay && (
            <p className="text-sm text-gray-600 mt-1 long-copy">{posDisplay}</p>
          )}
          {data.mnemonic && (
            <p className="text-base text-gray-500 italic mt-3 max-w-xl mx-auto long-copy">
