-- GPT Image-2 premium card pricing.
--
-- Keeps submit_generation authoritative for the selected card image tier:
-- video = 10 credits/word, standard card = 1 credit/word,
-- GPT Image-2 card = 5 credits/word.
