-- Phase 1E guard fix.
--
-- The first Phase 1E migration intentionally used triggers for targeted
-- pipeline-field blocking. This follow-up removes security-definer current_user
-- trust from the guard and marks the existing trusted user RPCs that legitimately
-- update deck/word pipeline fields.
